...
DEVPKEY_VPciDevice_Hot_Remove_Safe;
DEVPKEY_VPciDevice_Mitigations_Present;
DEVPKEY_VPciDevice_Supported;
GUID_BUS_INTERFACE_STANDARD;
GUID_DEVICE_RESET_INTERFACE_STANDARD;
GUID_DEVINTERFACE_DIRECTLY_ASSIGNABLE_DEVICE;
...
WPPTraceSuite;
WPP_4a8a9d9b04f73eeb0ca900c9c9587580_Traceguids;
WPP_59230825e75437c16f57407e76fb655c_Traceguids;
WPP_5fa7c2f6431d3a9904219b0cc7f70342_Traceguids;
WPP_9c77f7092f643db0267840c10afeceda_Traceguids;
WPP_GLOBAL_Control;
WPP_MAIN_CB;
WPP_ThisDir_CTLGUID_PcipDriverTraceGuid;
WPP_e68784bd3bcd3fd5b30fc677f2ee6f27_Traceguids;
WdfBindInfo;
WdfDriverGlobals;
WdfFunctions_01015;
...
_imp_RtlDeleteElementGenericTable;
_imp_RtlEnumerateGenericTableWithoutSplaying;
_imp_RtlGetElementGenericTable;
_imp_RtlInitUnicodeString;
_imp_RtlInitializeGenericTable;
_imp_RtlInsertElementGenericTable;
_imp_RtlLookupElementGenericTable;
_imp_RtlNumberGenericTableElements;
...
CompleteIrpSignalEvent();
CreateMitigatedAddressSpace();
DeleteMitigatedAddressSpace();
DriverEntry();
ExposeInterface();
ExposeInterfaceExit();
ExposedInterfaceEntry();
FxDriverEntry();
FxDriverEntryWorker();
FxStubBindClasses();
FxStubDriverUnload();
FxStubDriverUnloadCommon();
GetFunctionAndDeviceNumber();
GetMemoryBarsFromResource();
GetMitigationCount();
GetMitigationRanges();
InitDeviceInformation();
InitializeMitigationMaps();
MitigationRangeAllocate();
MitigationRangeCompare();
MitigationRangeFree();
NotifyPnpEventAndWait();
ParseLocationString();
ParseMitigationString();
PcipD0Entry();
PcipD0Exit();
PcipDestroyDevice();
PcipDeviceAdd();
...
PcipPrepareHardware();
PcipReleaseHardware();
PcipRemoveAddedResources();
PcipUnload();
PreprocessPnpIrp();
ProcessMmioResource();
QueryMitigatedRange();
ReadActualConfigSpace();
ReadActualMemory();
ReadMitigatedRegister();
ReadWriteMitigatedRegister();
ReadWriteMitigatedSpace();
ReleaseKernelMutex();
ReplaceConfigMirrorMitigation();
ResetCompletion();
...
SetPowerPolicy();
SriovEventComplete();
TeardownMitigationMaps();
TlgDefineProvider_annotation__TlgPcipTraceLoggingProviderProv();
TlgEnableCallback();
UnblockAttach();
Virtualization_DereferenceInterface();
Virtualization_GetDeviceLocation();
Virtualization_GetResourceForBar();
Virtualization_GetVendorAndDevice();
Virtualization_QueryLuid();
Virtualization_QueryProbedBars();
Virtualization_ReadBlock();
Virtualization_ReadConfig();
Virtualization_ReferenceInterface();
Virtualization_ResetFunction();
Virtualization_SetPowerState();
Virtualization_WriteBlock();
Virtualization_WriteConfig();
WPP_RECORDER_SF_();
WPP_RECORDER_SF_D();
WPP_RECORDER_SF_Dq();
WPP_RECORDER_SF_d();
WPP_RECORDER_SF_iDDD();
WPP_RECORDER_SF_iqqiS();
WPP_RECORDER_SF_q();
WPP_RECORDER_SF_qD();
WPP_RECORDER_SF_qDD();
...
WppTraceCallback();
WriteActualConfigSpace();
WriteActualMemory();
WriteMitigatedRegister();
_GSHandlerCheck();
