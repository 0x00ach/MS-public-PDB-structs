...
struct _ECP_LIST;
struct _EHCI_IDLE_REF_CONTEXT;
struct _EJOB;
struct _ENDPOINT_DATA;
struct _ENDPOINT_PARAMETERS;
struct _ENDPOINT_SLOT;
struct _EPROCESS;
struct _ERESOURCE;
struct _ETHREAD;
...
struct _GUID;
struct _HCD_HSISOTD_LIST;
struct _HCD_HSISO_TRANSFER_DESCRIPTOR;
struct _HCD_QUEUEHEAD_DESCRIPTOR;
struct _HCD_SITD_LIST;
struct _HCD_SI_TRANSFER_DESCRIPTOR;
struct _HCD_TD_LIST;
struct _HCD_TRANSFER_DESCRIPTOR;
struct _HC_CAPABILITIES_REGISTER;
struct _HC_DEBUGPORT_REGISTERS;
struct _HC_OPERATIONAL_REGISTER;
struct _HW_ISOCHRONOUS_TD;
struct _HW_OVERLAY_AREA;
struct _HW_QUEUEHEAD_DESCRIPTOR;
struct _HW_QUEUE_ELEMENT_TD;
struct _HW_SPLIT_ISOCHRONOUS_TD;
...
union HC_OVLAY_9;
union _CONFIGFLAG;
union _DEBUGPORTCONTROL;
union _DEBUGPORTDATABUFFER;
union _DEBUGPORTDEVICEADDRESS;
union _DEBUGPORTUSBPIDS;
union _FRINDEX;
union _HCCPARAMS;
union _HCLENGTHVERSION;
union _HCSPARAMS;
union _HC_BUFFER_POINTER;
union _HC_ENDPOINT_CAPABILITIES;
union _HC_ENDPOINT_CHARACTERSITICS;
union _HC_ITD_BUFFER_POINTER;
union _HC_ITD_BUFFER_POINTER0;
union _HC_ITD_BUFFER_POINTER1;
union _HC_ITD_BUFFER_POINTER2;
union _HC_ITD_TRANSACTION;
union _HC_QTD_TOKEN;
union _HC_SITD_BUFFER_POINTER0;
union _HC_SITD_BUFFER_POINTER1;
union _HC_SITD_CAPS;
union _HC_SITD_CONTROL;
union _HC_SITD_STATE;
union _HW_LINK_POINTER;
union _HW_TRANSFER_DESCRIPTOR;
union _KGDTENTRY64;
union _KIDTENTRY64;
...
enum POWER_ACTION;
enum _ASYNC_DOORBELL_STATE;
enum _ASYNC_SCHEDULE_STATE;
...
enum _EHCI_HW_SYNC;
enum _EHCI_IDLE_REF_TYPE;
enum _EHCI_TRANSFER_TYPE;
...
typedef struct _DEVICE_DATA {
    ULONG Sig;
    struct _DEVICE_OBJECT *HostControllerFdo;
    struct _DEVICE_OBJECT *TargetDeviceObject;
    struct _LIST_ENTRY AllEpListHead;
    ...
    UCHAR Bit64AddressingCapabilityOverride;
    UCHAR CompanionControllerHandoffEnabled;
    UCHAR IsAmdSB600Chipset;
    UCHAR IsIntelOakTrailChipset;
    UCHAR TerminateQH;
    UCHAR AsyncQhIdleRemoval;
    UCHAR AsyncQhIdleRemovalOverride;
    UCHAR AsyncQueueHeadDummyEnable;
    UCHAR AsyncQueueHeadDummyEnableOverride;
    UCHAR DisableAMDAsyncQhCache;
    UCHAR DisableAMDAsyncQhCacheOverride;
    ULONG SlotsPerEndpoint;
    UCHAR PciConfigSpaceDisabled;
    UCHAR EvaluateAcpiMethodOnResetSucceeded;
    ULONG ImmediateAsyncEnableChange;
    ULONG ImmediatePeriodicEnableChange;
    ULONG SstoolApiActive;
    struct _LIST_ENTRY PendingSmodeCTB_ListHead;
    struct _LIST_ENTRY PendingSmodeINT_ListHead;
    struct _LIST_ENTRY PendingIsochListHead;
    struct _LIST_ENTRY AsyncIdleRefListHead;
    ULONG AsyncIdleRefNoRes;
    struct _HC_OPERATIONAL_REGISTER *OperationalRegisters;
    struct _HC_CAPABILITIES_REGISTER *CapabilitiesRegisters;
    struct _HC_DEBUGPORT_REGISTERS *DebugPortRegisters;
    struct _KINTERRUPT *Interrupt;
    union _USBINTR EnabledInterrupts;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *AsyncQueueHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *AsyncQueueHeadDummy;
    struct _LIST_ENTRY AcfListHead;
    ULONG64 AcfListSpin;
    struct _KTHREAD *AcfLockThread;
    struct _ENDPOINT_DATA *EpAtTheDoor;
    ...
    struct _HCD_QUEUEHEAD_DESCRIPTOR *LockPrevQh;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *LockNextQh;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *LockQh;
    PVOID CommonBufferVa;
    ULONG CommonBufferPhys;
    ULONG CommonBufferBytes;
    PVOID CommonBufferBlocksVa;
    ULONG CommonBufferBlocksPhys;
    ULONG CommonBufferBlockBytes;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *StaticInterruptQH[65];
    PULONG FrameListBaseAddress;
    ULONG FrameListBasePhys;
    struct _ENDPOINT_DATA *IsoEndpointListHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *DummyQueueHeads;
    ULONG DummyQueueHeadsPhys;
    ULONG PeriodicListBaseSave;
    ULONG AsyncListAddrSave;
    ULONG SegmentSelectorSave;
    union _USBCMD CmdSave;
    union _USBINTR IntrSave;
    USHORT Vid;
    USHORT Dev;
    union _CONFIGFLAG CurrentConfigFlag;
    union _CONFIGFLAG SuspendConfigFlag;
    ...
    UCHAR DeviceStarted;
    UCHAR SavedFladj;
    PVOID PortResetCb[15];
    struct _EHCI_IDLE_REF_CONTEXT *PortResetCbRef[15];
    ...
    enum _ASYNC_SCHEDULE_STATE AsyncScheduleState;
    enum _ASYNC_DOORBELL_STATE AsyncDoorbellState;
    enum _PERIODIC_SCHEDULE_STATE PeriodicScheduleState;
    ULONG EhciInternalFlags;
    UCHAR PreventCmdChangesWithDoorbellPending;
    UCHAR OptimizeInactiveQhFlush;
    UCHAR DisableTwoDoorbellWorkaround;
    UCHAR StrictTransitionChecksEnabled;
    UCHAR IntegratedTTSupportRegistryOverride;
    ...
    union _PORTSC SuspendPortStatus[15];
    union _PORTSC ResumePortStatus[15];
    LONG ResumeTimeRefCount[15];
    UCHAR ResumeSignalTime[15];
    enum _INTEGRATED_TT_FLAVOR IntegratedTTSupport;
    UCHAR StopHcForPortOperations;
    UCHAR InvalidateRootHub;
};
...
typedef struct _EHCI_IDLE_REF_CONTEXT {
    struct _LIST_ENTRY IdleRefLink;
    ULONG Sig;
    enum _EHCI_IDLE_REF_TYPE RefType;
    PVOID RefObject;
};
...
typedef struct _ENDPOINT_DATA {
    struct _LIST_ENTRY AcfLink;
    struct _LIST_ENTRY AllEpLink;
    ULONG Sig;
    struct _ENDPOINT_PARAMETERS Parameters;
    enum _MP_ENDPOINT_STATUS EpStatus;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *QueueHead;
    ULONG Flags;
    enum _EHCI_HW_SYNC HwSyncState;
    union _LARGE_INTEGER StateChangeTc;
    ULONG DoorbellCount;
    ULONG SmodeTransfers;
    struct _LIST_ENTRY SmodeTransferListHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *StaticQH;
    struct _PERIOD_TABLE *PeriodTableEntry;
    struct _HCD_TD_LIST *TdList;
    struct _HCD_SITD_LIST *SiTdList;
    struct _HCD_HSISOTD_LIST *HsIsoTdList;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *NextFrameStaticQH;
    ULONG TdCount;
    ULONG FreeTds;
    ULONG LastFrame;
    ULONG QhChkPhys;
    PVOID QhChk;
    enum _EHCI_TRANSFER_TYPE TransferTypeFlag;
    ULONG IsochTransfers;
    struct _LIST_ENTRY IsoTransferListHead;
    struct _LIST_ENTRY DoneTdList;
    enum _MP_ENDPOINT_STATE CurEpState;
    struct _ENDPOINT_DATA *PrevEndpoint;
    struct _ENDPOINT_DATA *NextEndpoint;
    struct _HCD_TRANSFER_DESCRIPTOR *SetupTD;
    ...
    LONG SlotSequence;
    ULONG SlotCount;
    struct _ENDPOINT_SLOT *CurrentSlot;
    struct _ENDPOINT_SLOT *SlotPtr[2];
    struct _ENDPOINT_SLOT Slots[2];
};
...
typedef struct _ENDPOINT_SLOT {
    ULONG Idx;
    LONG Sequence;
    enum _SLOT_STATE State;
    struct _TRANSFER_CONTEXT *TransferContext;
    struct _HCD_TRANSFER_DESCRIPTOR *FirstTd;
    struct _HCD_TRANSFER_DESCRIPTOR *Tds[32];
};
...
typedef struct _HCD_HSISOTD_LIST {
    struct _HCD_HSISO_TRANSFER_DESCRIPTOR Td[1];
};

typedef struct _HCD_HSISO_TRANSFER_DESCRIPTOR {
    struct _HW_ISOCHRONOUS_TD HwTD;
    ULONG Sig;
    ULONG PhysicalAddress;
    ULONG HostFrame;
    struct _MP_HW_POINTER FirstPacket;
    struct _MP_HW_POINTER NextLink;
    struct _MP_HW_POINTER Transfer;
};

typedef struct _HCD_QUEUEHEAD_DESCRIPTOR {
    struct _HW_QUEUEHEAD_DESCRIPTOR HwQH;
    ULONG PhysicalAddress;
    ULONG Sig;
    ULONG QhFlags;
    ULONG Ordinal;
    ...
    struct _MP_HW_POINTER NextQh;
    struct _MP_HW_POINTER PrevQh;
    struct _MP_HW_POINTER NextLink;
    ULONG PadToX32[1];
};

typedef struct _HCD_SITD_LIST {
    struct _HCD_SI_TRANSFER_DESCRIPTOR Td[1];
};

typedef struct _HCD_SI_TRANSFER_DESCRIPTOR {
    struct _HW_SPLIT_ISOCHRONOUS_TD HwTD;
    ULONG Sig;
    ULONG PhysicalAddress;
    ULONG StartOffset;
    ULONG Reserved;
    struct _MP_HW_POINTER Packet;
    struct _MP_HW_POINTER Transfer;
    struct _MP_HW_POINTER NextLink;
    ULONG PadToX[6];
};
...
typedef struct _HCD_TRANSFER_DESCRIPTOR {
    struct _HW_QUEUE_ELEMENT_TD HwTD;
    ULONG Sig;
    ULONG Flags;
    ...
    struct _MP_HW_POINTER AltNextHcdTD;
    UCHAR Packet[8];
    struct _MP_HW_POINTER SlotNextHcdTD;
    struct _LIST_ENTRY DoneLink;
};

typedef struct _HC_CAPABILITIES_REGISTER {
    union _HCLENGTHVERSION HcLengthVersion;
    union _HCSPARAMS HcStructuralParameters;
    union _HCCPARAMS HcCapabilityParameters;
};

typedef struct _HC_DEBUGPORT_REGISTERS {
    union _DEBUGPORTCONTROL Control;
    union _DEBUGPORTUSBPIDS USBPIDs;
    union _DEBUGPORTDATABUFFER DataBuffer0;
    union _DEBUGPORTDATABUFFER DataBuffer1;
    union _DEBUGPORTDEVICEADDRESS DeviceAddress;
};

typedef struct _HC_OPERATIONAL_REGISTER {
    union _USBCMD UsbCommand;
    union _USBSTS UsbStatus;
    union _USBINTR UsbInterruptEnable;
    union _FRINDEX UsbFrameIndex;
    ULONG SegmentSelector;
    ULONG PeriodicListBase;
    ULONG AsyncListAddr;
    union _TTCTRL TTControl;
    ULONG ReservedB0[4];
    ULONG ReservedB1[4];
    union _CONFIGFLAG ConfigFlag;
    union _PORTSC PortRegister[1];
};

typedef struct _HW_ISOCHRONOUS_TD {
    union _HW_LINK_POINTER NextLink;
    union _HC_ITD_TRANSACTION Transaction[8];
    union _HC_ITD_BUFFER_POINTER0 BufferPointer0;
    union _HC_ITD_BUFFER_POINTER1 BufferPointer1;
    union _HC_ITD_BUFFER_POINTER2 BufferPointer2;
    union _HC_ITD_BUFFER_POINTER BufferPointer3;
    union _HC_ITD_BUFFER_POINTER BufferPointer4;
    union _HC_ITD_BUFFER_POINTER BufferPointer5;
    union _HC_ITD_BUFFER_POINTER BufferPointer6;
    ULONG BufferPointer64[7];
};

typedef struct _HW_OVERLAY_AREA {
    union _HW_LINK_POINTER Next_qTD;
    union _HW_LINK_POINTER AltNext_qTD;
    union _HC_QTD_TOKEN Token;
    union _HC_BUFFER_POINTER BufferPage0;
    union HC_OVLAY_8 OverlayDw8;
    union HC_OVLAY_9 OverlayDw9;
    union _HC_BUFFER_POINTER BufferPage3;
    union _HC_BUFFER_POINTER BufferPage4;
    ULONG BufferPage64[5];
};

typedef struct _HW_QUEUEHEAD_DESCRIPTOR {
    union _HW_LINK_POINTER HLink;
    union _HC_ENDPOINT_CHARACTERSITICS EpChars;
    union _HC_ENDPOINT_CAPABILITIES EpCaps;
    union _HW_LINK_POINTER CurrentTD;
    union _HW_TRANSFER_DESCRIPTOR Overlay;
};
...
typedef struct _HW_QUEUE_ELEMENT_TD {
    ...
    union _HW_LINK_POINTER AltNext_qTD;
    union _HC_QTD_TOKEN Token;
    union _HC_BUFFER_POINTER BufferPage[5];
    ULONG BufferPage64[5];
};

typedef struct _HW_SPLIT_ISOCHRONOUS_TD {
    union _HW_LINK_POINTER NextLink;
    union _HC_SITD_CAPS Caps;
    union _HC_SITD_CONTROL Control;
    union _HC_SITD_STATE State;
    union _HC_SITD_BUFFER_POINTER0 BufferPointer0;
    union _HC_SITD_BUFFER_POINTER1 BufferPointer1;
    union _HW_LINK_POINTER BackPointer;
...
typedef struct _TRANSFER_CONTEXT {
    struct _LIST_ENTRY DD_TransferLink;
    ULONG Sig;
    ULONG PendingTds;
    ...
    ULONG FrameComplete;
    struct _LIST_ENTRY TransferLink;
...
typedef union _HCCPARAMS {
    ULONG ul;
    ULONG Bit64Addressing : 1;
    ULONG ProgramableFrameList : 1;
    ULONG AsynSchedulePark : 1;
    ULONG Reserved1 : 1;
    ULONG IsochronousThreshold : 4;
    ULONG EECP : 8;
    ULONG PeriodicScheduleUpdate : 1;
    ULONG Reserved2 : 15;
};
...
typedef union _HCSPARAMS {
    ULONG ul;
    ULONG NumberOfPorts : 4;
    ULONG PortPowerControl : 1;
    ULONG Reserved1 : 3;
    ULONG NumberOfPortsPerCompConroller : 4;
    ULONG NumberOfCompControllers : 4;
    ULONG PortLEDs : 1;
    ULONG Reserved2 : 3;
...
typedef union _HW_TRANSFER_DESCRIPTOR {
    struct _HW_QUEUE_ELEMENT_TD qTD;
    struct _HW_OVERLAY_AREA Ov;
};
...
typedef union _PORTSC {
    ULONG ul;
    ULONG PortConnect : 1;
    ULONG PortConnectChange : 1;
    ULONG PortEnable : 1;
    ULONG PortEnableChange : 1;
    ULONG OvercurrentActive : 1;
    ULONG OvercurrentChange : 1;
    ULONG ForcePortResume : 1;
    ULONG PortSuspend : 1;
    ULONG PortReset : 1;
    ULONG HighSpeedDevice : 1;
    ULONG LineStatus : 2;
    ULONG PortPower : 1;
    ULONG PortOwnedByCC : 1;
    ULONG PortIndicator : 2;
    ULONG PortTestControl : 4;
    ULONG WakeOnConnect : 1;
    ULONG WakeOnDisconnect : 1;
    ULONG WakeOnOvercurrent : 1;
    ULONG Reserved : 3;
    ULONG LowSpeed : 1;
    ULONG HiSpeed : 1;
    ULONG Reserved2 : 4;
...
typedef union _TTCTRL {
    ULONG ul;
    ULONG TTStatus : 1;
    ULONG TTClear : 1;
    ULONG Reserved : 22;
    ULONG TTHubAddress : 7;
    ULONG Rsvd : 1;
};
...
typedef union _USBCMD {
    ULONG ul;
    ULONG HostControllerRun : 1;
    ULONG HostControllerReset : 1;
    ULONG FrameListSize : 2;
    ULONG PeriodicScheduleEnable : 1;
    ULONG AsyncScheduleEnable : 1;
    ULONG IntOnAsyncAdvanceDoorbell : 1;
    ULONG HostControllerLightReset : 1;
    ULONG ParkModeCount : 2;
    ULONG ReservedMBZ : 1;
    ULONG ParkModeEnable : 1;
    ULONG PrefetchEnable : 1;
    ULONG Reserved1 : 3;
...
typedef union _USBSTS {
    ...
    ULONG HostSystemError : 1;
    ULONG IntOnAsyncAdvance : 1;
    ULONG ReservedStatus : 6;
    ULONG HcHalted : 1;
    ULONG Reclimation : 1;
    ULONG PeriodicScheduleStatus : 1;
    ULONG AsyncScheduleStatus : 1;
    ULONG Reserved : 16;
};
...
typedef enum _EHCI_IDLE_REF_TYPE {
    SstoolAPI = 1,
    RH_PortResumeComplete = 2,
    RH_FinishReset = 3,
    RH_PortResetComplete = 4
};
...
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_1;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_2;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_3;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_4;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_5;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_COMPLETE_ERROR_6;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_RESUME_DISPATCH;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE_ERROR_1;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE_ERROR_2;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE_ERROR_3;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE_ERROR_4;
USBPORT_ETW_EVENT_HC_EHCI_MINIPORT_START_COMPLETE_ERROR_5;
...
_imp_RtlGetVersion;
_imp_USBPORT_GetHciMn;
_imp_USBPORT_IsControllerInHibernatePath;
