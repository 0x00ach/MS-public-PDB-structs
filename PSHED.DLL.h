...
PluginCallbacks;
PshedFAMask;
PshedpBootErrSrcConfiguration;
PshedpBootErrorRegion;
PshedpBootErrorRegionLength;
PshedpBootErrorSourceId;
PshedpCachedEinj;
PshedpCachedErst;
PshedpCurrentErrorRecordIndex;
PshedpDefaultErrorSources;
PshedpE820DescriptorFound;
PshedpErrorLogDescriptor;
PshedpErrorRecordNameCount;
PshedpErrorRecordNames;
PshedpErrorSourceCount;
PshedpErrorSourceProcessingLock;
PshedpErrorSources;
PshedpFirmwareTypeEfi;
PshedpGlobalPCIEBRIDGEErrorSource;
PshedpGlobalPCIEBRIDGEErrorSourceValid;
PshedpGlobalPCIEDEVICEErrorSource;
PshedpGlobalPCIEDEVICEErrorSourceValid;
PshedpGlobalPCIEROOTPORTErrorSource;
PshedpGlobalPCIEROOTPORTErrorSourceValid;
PshedpGlobalXPFMCEErrorSource;
PshedpHESTProcessed;
PshedpHestErrorSourceCount;
PshedpHestErrorSources;
PshedpInitialized;
PshedpInjectionActionTable;
PshedpInjectionActionTableValid;
PshedpMaximumErrorLogSize;
PshedpMaximumErrorLogStorageSize;
PshedpOscImplemented;
PshedpPersistBuffer;
PshedpPersistBufferSize;
PshedpRecordName;
PshedpRemainingErrorLogStorageSize;
PshedpSerializationActionTable;
PshedpVariableNames;
PshedpVariableNamesLength;
PshedpVendorDefinedErrorExtensionOffset;
...
_imp_HalBugCheckSystem;
_imp_HalDispatchTable;
_imp_HalEnumerateEnvironmentVariablesEx;
...
_imp_MmMapIoSpaceEx;
_imp_MmUnmapIoSpace;
_imp_NtGetEnvironmentVariableEx;
_imp_NtQueryEnvironmentVariableInfoEx;
...
PshedpClearErrorRecord();
PshedpClearErrorRecordERST();
PshedpCorrectBootErrSrc();
PshedpDetermineIndexOfNextErrorRecord();
PshedpDoCheckBusyStatus();
PshedpDoEndOperation();
PshedpDoExecuteOperation();
PshedpDoGetCommandStatus();
PshedpDoGetTriggerErrorActionTable();
PshedpDoSetErrorTypeWithAddress();
PshedpDoSetRecordIdentifier();
PshedpDoSetRecordOffset();
PshedpExecuteAddValueInstruction();
PshedpExecuteMoveDataInstruction();
PshedpExecuteReadRegisterInstruction();
PshedpExecuteReadRegisterValueInstruction();
PshedpExecuteStallWhileTrueInstruction();
PshedpExecuteSubtractValueInstruction();
PshedpExecuteWriteRegisterInstruction();
PshedpExecuteWriteRegisterValueInstruction();
PshedpGetAllErrorSources();
PshedpGetErrorLogAddressRangeInfo();
PshedpGetErrorRecordNameList();
PshedpGetErrorSourceInfo();
PshedpInitAERBridgeSource();
PshedpInitAERDeviceSource();
PshedpInitAERRootportSource();
PshedpInitBootErrSrc();
PshedpInitGenericErrorSource();
PshedpInitGenericErrorSourceV2();
PshedpInitPersistence();
PshedpInitTableEntryFromACPIEntry();
PshedpInitXPFCMCErrorSource();
PshedpInitXPFMCEErrorSource();
PshedpInitializeErrorSourceInfo();
PshedpInjectErrorEINJ();
PshedpIsWheaOscImplemented();
PshedpProcessEINJ();
PshedpProcessERST();
PshedpProcessErrorSourceInfo();
PshedpProcessHEST();
PshedpPublishPluginPresence();
PshedpReadErrorRecord();
PshedpReadErrorRecordEFI();
PshedpReadErrorRecordERST();
PshedpReadRegisterRegion();
PshedpShrinkRecordForWrite();
PshedpValidateErrorSourceArray();
PshedpWriteErrorRecord();
PshedpWriteErrorRecordERST();
RtlStringCchPrintfW();
_GSHandlerCheck();
