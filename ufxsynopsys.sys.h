...
struct _ACPI_DEVICE_INFORMATION;
struct _ACPI_NOTIFICATION_CONTEXT;
struct _ATTACH_INTERFACE_CONTEXT;
struct _CM_FULL_RESOURCE_DESCRIPTOR;
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR;
struct _CM_PARTIAL_RESOURCE_LIST;
struct _CM_RESOURCE_LIST;
struct _COMPRESSED_DATA_INFO;
struct _CONFIGURABLE_CHARGER_PROPERTY_HEADER;
struct _CONTEXT;
struct _CONTROLLER_CONTEXT;
struct _CONTROL_CONTEXT;
struct _CSR_REGISTERS;
struct _CUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG;
struct _DEVICE_CAPABILITIES;
struct _DEVICE_COMMAND_REGISTERS;
struct _DEVICE_COMMON_REGISTERS;
struct _DEVICE_DATA_SET_RANGE;
struct _DEVICE_DSM_DEFINITION;
struct _DEVICE_ENDPOINT_COMMAND_REGISTERS;
struct _DEVICE_ENDPOINT_REGISTERS;
struct _DEVICE_INTERRUPT_CONTEXT;
struct _DEVICE_MANAGE_DATA_SET_ATTRIBUTES;
struct _DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT;
struct _DEVICE_OBJECT;
struct _DEVICE_OBJECT_POWER_EXTENSION;
struct _DEVICE_REGISTERS;
...
struct _ECP_LIST;
struct _EJOB;
struct _ENDPOINT_QUEUE_CONTEXT;
struct _EPROCESS;
struct _ERESOURCE;
struct _ETHREAD;
struct _ETW_CHARGER_DETECTION_ERROR;
struct _ETW_DETERMINE_PORT_TYPE_ERROR;
struct _ETW_ERROR_RECORD_CONTEXT;
struct _EVENT_BUFFER_CONTEXT;
...
struct _GLOBAL_COMMON_REGISTERS;
struct _GLOBAL_DEBUG_REGISTERS;
struct _GLOBAL_DMA_PRIORITY_REGISTERS;
struct _GLOBAL_EVENT_BUFFER_ADDRESS_REGISTER;
struct _GLOBAL_EVENT_BUFFER_REGISTERS;
struct _GLOBAL_FIFO_SIZE_REGISTERS;
struct _GLOBAL_PHY_REGISTERS;
struct _GLOBAL_REGISTERS;
...
struct _UFXDEVICE_CONTEXT;
struct _UFXENDPOINT_CONTEXT;
struct _UFXENDPOINT_INIT;
struct _UFX_DEVICE_CALLBACKS;
struct _UFX_DEVICE_CAPABILITIES;
struct _UFX_ENDPOINT_CALLBACKS;
struct _UFX_GLOBALS;
struct _UFX_HARDWARE_FAILURE_CONTEXT;
struct _UFX_INTERFACE_PROPRIETARY_CHARGER;
struct _UFX_PROPRIETARY_CHARGER;
struct _UNICODE_STRING;
struct _USBFN_INTERFACE_ATTACH;
struct _USBFN_ON_ATTACH;
...
union _DEVICE_COMMAND_REGISTER;
union _DEVICE_CONFIGURATION_REGISTER;
union _DEVICE_CONTROL_REGISTER;
union _DEVICE_ENDPOINT_COMMAND_REGISTER;
union _DEVICE_EVENT_ENABLE_REGISTER;
union _DEVICE_INTERRUPT_MODERATION_REGISTER;
union _DEVICE_STATUS_REGISTER;
union _GLOBAL_CORE_CONTROL_REGISTER;
union _GLOBAL_EVENT_BUFFER_EVENT_COUNT_REGISTER;
union _GLOBAL_EVENT_BUFFER_SIZE_REGISTER;
union _GLOBAL_FIFO_SIZE_REGISTER;
union _GLOBAL_SOC_BUS_CONFIGURATION_REGISTER0;
union _GLOBAL_SOC_BUS_CONFIGURATION_REGISTER1;
union _GLOBAL_STATUS_REGISTER;
union _KGDTENTRY64;
union _KIDTENTRY64;
union _KSE_SYNOPSYS_CONTROLLER_FLAGS;
union _LARGE_INTEGER;
union _OTG_CONFIGURATION_REGISTER;
union _OTG_CONTROL_REGISTER;
union _OTG_EVENTS_ENABLE_REGISTER;
union _OTG_EVENTS_REGISTER;
union _OTG_STATUS_REGISTER;
union _POWER_STATE;
union _SLIST_HEADER;
...
enum POWER_ACTION;
enum UFX_CONTROLLER_PARENT_BUS_TYPE;
enum _DEVICE_POWER_STATE;
enum _DEVICE_RELATION_TYPE;
enum _DEVICE_USAGE_NOTIFICATION_TYPE;
enum _DEVICE_WAKE_DEPTH;
enum _DIRECTORY_NOTIFY_INFORMATION_CLASS;
enum _DMA_EXECUTION_STATE;
enum _DMA_WIDTH;
enum _ETW_ERROR_TYPE;
enum _EVENT_TYPE;
...
enum _UFX_CLASS_FUNCTIONS;
enum _USBFN_ACTION;
enum _USBFN_ATTACH_ACTION;
enum _USBFN_BUS_SPEED;
enum _USBFN_DEVICE_STATE;
enum _USBFN_DIRECTION;
enum _USBFN_PORT_TYPE;
...
typedef struct UFXDEVICE__ {
    LONG unused;
};

typedef struct UFXENDPOINT__ {
    LONG unused;
};
...
typedef struct _ACPI_NOTIFICATION_CONTEXT {
    struct WDFDEVICE__ *Device;
    ULONG NotifyCode;
};

typedef struct _ATTACH_INTERFACE_CONTEXT {
...
typedef struct _CONTROLLER_CONTEXT {
    struct UFXDEVICE__ *UfxDevice;
    struct WDFINTERRUPT__ *DeviceInterrupt;
    struct WDFINTERRUPT__ *WakeInterrupt;
    struct WDFINTERRUPT__ *AttachInterrupt;
    struct WDFINTERRUPT__ *DetachInterrupt;
    struct _KEVENT DetachEvent;
    struct WDFDMAENABLER__ *DmaEnabler;
    struct _DEVICE_COMMON_REGISTERS *DeviceCommonRegisters;
    ULONG64 PortDetector;
    UCHAR WasAttached;
    UCHAR Attached;
    UCHAR GotAttachOrDetach;
    struct WDFSPINLOCK__ *DpcLock;
    UCHAR RemoteWakeupRequested;
    UCHAR StopPending;
    UCHAR ConnectionDone;
    UCHAR Suspended;
    enum _USB_DEVICE_SPEED Speed;
    struct _GUID BusTypeGuid;
    struct _WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS IdleSettings;
    struct _UFX_INTERFACE_PROPRIETARY_CHARGER ProprietaryChargerInterface;
    struct WDFWORKITEM__ *ProprietaryChargerDetectWorkItem;
    struct WDFWORKITEM__ *ProprietaryChargerSetPropertyWorkItem;
    struct WDFWORKITEM__ *ProprietaryChargerAbortOperationWorkItem;
    struct WDFWORKITEM__ *ProprietaryChargerResetOperationWorkItem;
    struct _UFX_PROPRIETARY_CHARGER DetectedCharger;
    LONG ProprietaryChargerOperationsInProgress;
    struct _USBFN_INTERFACE_ATTACH AttachInterface;
    struct WDFWORKITEM__ *GetAttachActionWorkItem;
    struct WDFWORKITEM__ *AbortGetAttachActionWorkItem;
    LONG GetAttachActionInProgress;
    struct ACPI_INTERFACE_STANDARD2 AcpiInterfaces;
    UCHAR AcpiGetPortType;
    UCHAR AcpiSetDeviceState;
    UCHAR UseAcpiNotifications;
    UCHAR AcpiUseCad;
    UCHAR InitializeDefaultEndpoint;
    struct WDFWAITLOCK__ *DevicePowerLock;
    union _KSE_SYNOPSYS_CONTROLLER_FLAGS DeviceFlags;
    enum UFX_CONTROLLER_PARENT_BUS_TYPE ParentBusType;
    struct _ACPI_DEVICE_INFORMATION AcpiDeviceInformation;
    struct _PCI_DEVICE_INFORMATION PciDeviceInformation;
    UCHAR AttachDisabled;
    UCHAR HibernationSupported;
    UCHAR AcpiSetPmu;
    UCHAR AcpiNotificationEnabledSupport;
    UCHAR AcpiSoftCoreReset;
    UCHAR Hibernated;
    UCHAR HibernatedWithRunStop;
    UCHAR ManufacturingModeEnabled;
    struct WDFSPINLOCK__ *Usb2PhyLock;
    ULONG EndpointCommandCount;
    UCHAR SuspendPhy;
    UCHAR SuperSpeedSupported;
    UCHAR InitializeController;
    enum _WDF_POWER_DEVICE_STATE DevicePowerState;
    struct WDFTIMER__ *InterruptWatchdogTimer;
    UCHAR ControllerRunning;
    UCHAR LiveKernelDumpGenerated;
    ULONG SynopsysId;
    struct RECORDER_LOG__ *RecorderLog;
    UCHAR SharesConnectors;
    ULONG GroupId;
    ULONG PowerDownScale;
};

typedef struct _CONTROL_CONTEXT {
    struct WDFCOMMONBUFFER__ *SetupPacketBuffer;
    UCHAR SetupRequested;
    UCHAR ReadyForHandshake;
    UCHAR HandshakeRequested;
    UCHAR DataStageExists;
    struct _USB_DEFAULT_PIPE_SETUP_PACKET *SetupPacket;
    struct WDFREQUEST__ *HandshakeRequest;
};

typedef struct _CSR_REGISTERS {
    struct _GLOBAL_REGISTERS GlobalRegisters;
    struct _DEVICE_REGISTERS DeviceRegisters;
    struct _OTG_REGISTERS OTGRegisters;
};
...
typedef struct _DEVICE_COMMAND_REGISTERS {
    ULONG Parameter;
    union _DEVICE_COMMAND_REGISTER Command;
};

typedef struct _DEVICE_COMMON_REGISTERS {
    union _DEVICE_CONFIGURATION_REGISTER Configuration;
    union _DEVICE_CONTROL_REGISTER Control;
    union _DEVICE_EVENT_ENABLE_REGISTER EnabledEvents;
    union _DEVICE_STATUS_REGISTER Status;
    struct _DEVICE_COMMAND_REGISTERS DeviceCommand;
    ULONG Reserved0[2];
};
...
typedef struct _DEVICE_ENDPOINT_COMMAND_REGISTERS {
    ...
    ULONG Parameter1;
    ULONG Parameter0;
    union _DEVICE_ENDPOINT_COMMAND_REGISTER EndpointCommand;
};

typedef struct _DEVICE_ENDPOINT_REGISTERS {
    ULONG EndpointEnable;
    ULONG Reserved0[55];
    struct _DEVICE_ENDPOINT_COMMAND_REGISTERS EndpointCommand[32];
    union _DEVICE_INTERRUPT_MODERATION_REGISTER DeviceInterruptModeration;
    ULONG Reserved1[127];
};

typedef struct _DEVICE_INTERRUPT_CONTEXT {
    struct WDFCOMMONBUFFER__ *EventBuffer;
    UCHAR InterruptFired;
};
...
typedef struct _DEVICE_REGISTERS {
    struct _DEVICE_COMMON_REGISTERS Common;
    struct _DEVICE_ENDPOINT_REGISTERS Endpoints;
};
...
typedef struct _DMA_CONTEXT {
    ...
    ULONG ExtraBytes;
    UCHAR DirectionIn;
    struct _SCATTER_GATHER_LIST *SgList;
    ULONG SgIndex;
    struct WDFREQUEST__ *Request;
    UCHAR ZeroLength;
    enum _DMA_EXECUTION_STATE ExecutionState;
    ULONG BytesRemaining;
    UCHAR CleanupOnProgramDma;
};
...
typedef struct _ETW_CHARGER_DETECTION_ERROR {
    struct WDFDEVICE__ *DeviceHandle;
    ULONG Status;
    ULONG CmdRegister;
    ULONG PortscRegister;
    ULONG OTGSCRegister;
};

typedef struct _ETW_DETERMINE_PORT_TYPE_ERROR {
    struct WDFDEVICE__ *DeviceHandle;
    ULONG Status;
};

typedef struct _ETW_ERROR_RECORD_CONTEXT {
    enum _ETW_ERROR_TYPE ErrorType;
    union {
        struct _ETW_CHARGER_DETECTION_ERROR ChargerDetection;
        struct _ETW_DETERMINE_PORT_TYPE_ERROR DeterminePortType;
    } ErrorInfo;
};

typedef struct _EVENT_BUFFER_CONTEXT {
    struct _GLOBAL_EVENT_BUFFER_REGISTERS *EventBufferRegisters;
...
typedef struct _GLOBAL_COMMON_REGISTERS {
    union _GLOBAL_SOC_BUS_CONFIGURATION_REGISTER0 SocBusConfig0;
    union _GLOBAL_SOC_BUS_CONFIGURATION_REGISTER1 SocBusConfig1;
    ULONG TxThresholdControl;
    ULONG RxThresholdControl;
    union _GLOBAL_CORE_CONTROL_REGISTER CoreControl;
    ULONG Reserved0;
    union _GLOBAL_STATUS_REGISTER Status;
    ULONG Reserved1;
    ULONG SynopsysID;
    ULONG GPIO;
    ULONG UserID;
...
typedef struct _GLOBAL_EVENT_BUFFER_REGISTERS {
    struct _GLOBAL_EVENT_BUFFER_ADDRESS_REGISTER EventBufferAddress;
    union _GLOBAL_EVENT_BUFFER_SIZE_REGISTER EventSize;
    union _GLOBAL_EVENT_BUFFER_EVENT_COUNT_REGISTER EventCount;
};

typedef struct _GLOBAL_FIFO_SIZE_REGISTERS {
    union _GLOBAL_FIFO_SIZE_REGISTER TxFIFOSize[32];
    union _GLOBAL_FIFO_SIZE_REGISTER RxFIFOSize[32];
};
...
typedef struct _GLOBAL_REGISTERS {
    struct _GLOBAL_COMMON_REGISTERS Common;
    ULONG SSPortToBusInstanceMapping[2];
    ULONG HWParameters0_7[8];
    struct _GLOBAL_DEBUG_REGISTERS Debug;
    ULONG HSPortToBusInstanceMapping[2];
    ULONG FSPortToBusInstanceMapping[2];
    ULONG Reserved0[28];
    struct _GLOBAL_PHY_REGISTERS Phy;
    struct _GLOBAL_FIFO_SIZE_REGISTERS FIFOSize;
    struct _GLOBAL_EVENT_BUFFER_REGISTERS EventBuffers[32];
    ULONG HWParameters8;
    ULONG Reserved1[3];
    struct _GLOBAL_DMA_PRIORITY_REGISTERS Priority;
    ULONG Reserved2[54];
};
...
typedef struct _OTG_REGISTERS {
    union _OTG_CONFIGURATION_REGISTER Configuration;
    union _OTG_CONTROL_REGISTER Control;
    union _OTG_EVENTS_REGISTER Events;
    union _OTG_EVENTS_ENABLE_REGISTER EventsEnable;
    union _OTG_STATUS_REGISTER Status;
    ULONG Reserved0[3];
};
...
typedef struct _PROPRIETARY_CHARGER_CONTEXT {
    struct UFXDEVICE__ *UfxDevice;
    struct WDFREQUEST__ *PropertyRequest;
};
...
typedef struct _REGISTERS_CONTEXT {
    PUCHAR Version;
    PUCHAR RegisterBase;
    ULONG64 RegistersLength;
    struct _CSR_REGISTERS *Registers;
};

typedef struct _REQUEST_CONTEXT {
    struct UFXENDPOINT__ *Endpoint;
    struct WDFDMATRANSACTION__ *Transaction;
    UCHAR QueueIsStopped;
    UCHAR ReferencedOnCancel;
};
...
typedef struct _TRANSFER_CONTEXT {
    struct WDFDEVICE__ *WdfDevice;
    struct WDFCOMMONBUFFER__ *TrbBuffer;
    struct WDFCOMMONBUFFER__ *ExtraBuffer;
    struct WDFDMATRANSACTION__ *Transaction;
    struct _TRB *Trbs;
    ULONG TrbHeadIndex;
    ULONG TrbTailIndex;
    struct WDFSPINLOCK__ *TransferLock;
    union _LARGE_INTEGER LogicalTrbBuffer;
    UCHAR TransferStarted;
    ULONG XferRscIdx;
    struct _DEVICE_ENDPOINT_COMMAND_REGISTERS *Registers;
    UCHAR EndRequested;
    ULONG ProgrammedTrbs;
    UCHAR Stalled;
    UCHAR Enabled;
    UCHAR TransferCommandStartComplete;
    UCHAR CleanupOnEndComplete;
    struct WDFWORKITEM__ *CompletionWorkItem;
    UCHAR PendingCompletion;
};
...
typedef struct _UFXDEVICE_CONTEXT {
    struct WDFDEVICE__ *FdoWdfDevice;
    struct WDFCOLLECTION__ *Endpoints;
    struct WDFCOLLECTION__ *ErrorRecords;
    struct UFXENDPOINT__ *PhysicalEndpointToUfxEndpoint[32];
    enum _USBFN_DEVICE_STATE UsbState;
    enum _USBFN_PORT_TYPE UsbPort;
    UCHAR IsIdle;
    UCHAR PdcpDetectionNeeded;
    struct WDFTIMER__ *DisconnectTimer;
    UCHAR Initialized;
};
...
typedef struct _UFXENDPOINT_CONTEXT {
    struct WDFDEVICE__ *WdfDevice;
    struct UFXDEVICE__ *UfxDevice;
    struct _USB_ENDPOINT_DESCRIPTOR Descriptor;
    struct _DEVICE_ENDPOINT_COMMAND_REGISTERS *Registers;
    ULONG PhysicalEndpoint;
    struct WDFREQUEST__ *StallRequest;
    struct WDFREQUEST__ *ClearRequest;
    UCHAR EndpointCommandSent;
    UCHAR EndpointCommandSent2;
    struct RECORDER_LOG__ *RecorderLog;
};
...
typedef struct _UFX_DEVICE_CALLBACKS {
    ULONG Size;
    PVOID EvtDeviceHostConnect;
    PVOID EvtDeviceHostDisconnect;
    PVOID EvtDeviceAddressed;
    PLONG EvtDeviceEndpointAdd;
    PVOID EvtDeviceDefaultEndpointAdd;
    PVOID EvtDeviceUsbStateChange;
    PVOID EvtDevicePortChange;
    PVOID EvtDevicePortDetect;
    PVOID EvtDeviceRemoteWakeupSignal;
    PVOID EvtDeviceControllerReset;
    PVOID EvtDeviceTestModeSet;
    PLONG EvtDeviceTestHook;
    PVOID EvtDeviceSuperSpeedPowerFeature;
    PVOID EvtDeviceProprietaryChargerDetect;
    PVOID EvtDeviceProprietaryChargerSetProperty;
    PVOID EvtDeviceProprietaryChargerReset;
};

typedef struct _UFX_DEVICE_CAPABILITIES {
    ULONG Size;
    enum _USB_DEVICE_SPEED MaxSpeed;
...
typedef struct _UFX_GLOBALS {
    ULONG Size;
    struct _WDF_DRIVER_GLOBALS *WdfDriverGlobals;
};
...
typedef struct _UFX_INTERFACE_PROPRIETARY_CHARGER {
    ...
    PLONG ProprietaryChargerDetect;
    PLONG ProprietaryChargerSetProperty;
    PLONG ProprietaryChargerAbortOperation;
    PLONG ProprietaryChargerResetOperation;
};
...
typedef struct _USBFN_INTERFACE_ATTACH {
    struct _INTERFACE InterfaceHeader;
    PLONG GetAttachAction;
    PLONG GetAttachActionAbortOperation;
    PLONG SetDeviceState;
};

typedef struct _USBFN_ON_ATTACH {
    enum _USBFN_PORT_TYPE PortType;
    enum _USBFN_ATTACH_ACTION AttachAction;
};
...
typedef union _DEVICE_INTERRUPT_MODERATION_REGISTER {
    ULONG AsUlong32;
    ULONG ModerationInterval : 16;
    ULONG InterruptModerationDownCounter : 16;
};
...
typedef union _KSE_SYNOPSYS_CONTROLLER_FLAGS {
    ULONG64 AsULong64;
    ULONG64 LegacyPortDetection : 1;
    ULONG64 UseVendorRegisters : 1;
    ULONG64 VendorPciSoftReset : 1;
    ULONG64 UseD2StateForIDCP : 1;
    ULONG64 DisableDeviceInitiatedU1U2 : 1;
    ULONG64 SetUsb3PhySuspendOnSoftReset : 1;
    ULONG64 DeferInitialization : 1;
    ULONG64 InterruptModeration : 1;
    ULONG64 HwBasedChargerDetection : 1;
};
...
typedef enum UFX_CONTROLLER_PARENT_BUS_TYPE {
    UfxParentBusTypeCustom = 0,
    UfxParentBusTypePci = 1,
    UfxParentBusTypeAcpi = 2
};
...
typedef enum _DMA_EXECUTION_STATE {
    NotExecuted = 0,
    Executed = 1,
    Cancelled = 2,
    Completed = 3
...
typedef enum _ETW_ERROR_TYPE {
    Error_ChargerDetection = 0,
    Error_DeterminePortType = 1
};
...
typedef enum _UFX_CLASS_FUNCTIONS {
    UfxFdoInitIndex = 0,
    UfxDeviceCreateIndex = 1,
    UfxDeviceEventCompleteIndex = 2,
    UfxDeviceNotifyHardwareReadyIndex = 3,
    UfxDeviceNotifyAttachIndex = 4,
    UfxDeviceNotifyDetachIndex = 5,
    UfxDeviceNotifySuspendIndex = 6,
    UfxDeviceNotifyResumeIndex = 7,
    UfxDeviceNotifyResetIndex = 8,
    UfxDevicePortDetectCompleteIndex = 9,
    UfxDeviceProprietaryChargerDetectCompleteIndex = 10,
    UfxDeviceNotifyHardwareFailureIndex = 11,
    UfxDeviceIoControlIndex = 12,
    UfxDeviceIoInternalControlIndex = 13,
    UfxEndpointCreateIndex = 14,
    UfxEndpointInitSetEventCallbacksIndex = 15,
    UfxEndpointNotifySetupIndex = 16,
    UfxEndpointGetTransferQueueIndex = 17,
    UfxEndpointGetCommandQueueIndex = 18,
    UfxDevicePortDetectCompleteExIndex = 19,
    UfxDeviceNotifyFinalExitIndex = 20,
    UfxFunctionsMax = 21
};
...
typedef enum _USBFN_ACTION {
    UsbfnActionNone = 0,
    UsbfnActionNoCad = 1,
    UsbfnActionDetectProprietaryCharger = 2
};

typedef enum _USBFN_ATTACH_ACTION {
    UsbfnPortDetected = 0,
    UsbfnPortDetectedNoCad = 1,
    UsbfnProceedWithAttach = 2,
    UsbfnIgnoreAttach = 3,
    UsbfnDetectProprietaryCharger = 4,
    UsbfnHwBasedChargerDetection = 5
};
...
Action;
ActionTable_Detector_Detecting_Stopped_Detector;
ActionTable_Detector_Stopped_Stopped_Detector;
Actions_Detector_Aca_Detecting_Detector_Packed;
Actions_Detector_CheckCharging_Detecting_Detector_Packed;
Actions_Detector_CheckDcd_Detecting_Detector_Packed;
Actions_Detector_DcpOrCdp2_Detecting_Detector_Packed;
Actions_Detector_DcpOrCdp_Detecting_Detector_Packed;
Actions_Detector_Detecting_Detecting_Detector_Packed;
Actions_Detector_Detecting_Stopped_Detector_Packed;
Actions_Detector_DisablingDcd_Detecting_Detector_Packed;
Actions_Detector_EnablingDcd_Detecting_Detector_Packed;
Actions_Detector_Stopped_Stopped_Detector_Packed;
Actions_Detector_Stopping_Stopped_Detector_Packed;
ChargerDetectionError;
ConnectedStandbyInformation;
CreateMachine;
DebugMessage;
DebugMessageInt;
Dequeue;
DeterminePortTypeFailed;
DriverDecl_PortDetector;
EndpointCommand;
EndpointInformation;
Enqueue;
EventSetMbrs_Detector_None_Packed;
EventSetMbrs_Detector_defer_Detecting_Stopped_Detector_Packed;
EventSetTable_Detector;
EventTable;
Exit;
FailedNtStatus;
...
Microsoft_WindowsPhone_UfxSynopsysEnableBits;
Microsoft_WindowsPhone_UfxSynopsysKeywords;
Microsoft_WindowsPhone_UfxSynopsysLevels;
QueueResize;
RegisterInformation;
RegisterRead;
RegisterWrite;
...
TransTable_Detector_CheckCharging_Detecting_Detector;
TransTable_Detector_CheckDcd_Detecting_Detector;
TransTable_Detector_DcpOrCdp_Detecting_Detector;
TransTable_Detector_Detecting_Detecting_Detector;
TransTable_Detector_Detecting_Stopped_Detector;
TransTable_Detector_DisablingDcd_Detecting_Detector;
TransTable_Detector_EnablingDcd_Detecting_Detector;
TransTable_Detector_Stopped_Stopped_Detector;
TransTable_Detector_Stopping_Stopped_Detector;
Transfer;
Transition;
Transitions_Detector_Aca_Detecting_Detector_Packed;
Transitions_Detector_CheckCharging_Detecting_Detector_Packed;
Transitions_Detector_CheckDcd_Detecting_Detector_Packed;
Transitions_Detector_DcpOrCdp2_Detecting_Detector_Packed;
Transitions_Detector_DcpOrCdp_Detecting_Detector_Packed;
Transitions_Detector_Detecting_Detecting_Detector_Packed;
Transitions_Detector_Detecting_Stopped_Detector_Packed;
Transitions_Detector_DisablingDcd_Detecting_Detector_Packed;
Transitions_Detector_EnablingDcd_Detecting_Detector_Packed;
Transitions_Detector_Stopped_Stopped_Detector_Packed;
Transitions_Detector_Stopping_Stopped_Detector_Packed;
TrbLog;
UFX_BIND_INFO;
USBFN_DSM_ATTACH_AND_PORT_DETECTION_GUID;
USBFN_DSM_VENDOR_PROPERTIES_GUID;
USBFN_FILTER_INTERFACE_CONTROLLER_RESET;
UfxClassFunctions;
UfxGlobals;
UfxGuid;
UfxGuid_Context;
UfxSynopsysGuid;
UfxSynopsysGuid_Context;
Unhandled;
VarTable_Detector;
WDF_ATTACH_INTERFACE_CONTEXT_TYPE_INFO;
WDF_CONTROLLER_CONTEXT_TYPE_INFO;
WDF_CONTROL_CONTEXT_TYPE_INFO;
WDF_DETECTOR_TIMER_CONTEXT_TYPE_INFO;
WDF_DEVICE_INTERRUPT_CONTEXT_TYPE_INFO;
WDF_DMA_CONTEXT_TYPE_INFO;
WDF_ENDPOINT_QUEUE_CONTEXT_TYPE_INFO;
WDF_ETW_ERROR_RECORD_CONTEXT_TYPE_INFO;
WDF_EVENT_BUFFER_CONTEXT_TYPE_INFO;
WDF_PROPRIETARY_CHARGER_CONTEXT_TYPE_INFO;
WDF_REGISTERS_CONTEXT_TYPE_INFO;
...
WPPTraceSuite;
WPP_028bfa69a4cf35c95b4f5bca037de562_Traceguids;
WPP_03124503c58c34ae62eba55964e1c870_Traceguids;
WPP_2f3ddafce604364f870df1359a89c96b_Traceguids;
WPP_3a8b82a42adf335d0135dfd3d3fe48b5_Traceguids;
WPP_742a74644bfe37bbead3d675dc7fe83b_Traceguids;
WPP_985f086c49123cc3af3d40fcc699aef6_Traceguids;
WPP_9f4500e6f90e3282b1f159840399e28f_Traceguids;
WPP_GLOBAL_Control;
WPP_MAIN_CB;
WPP_ThisDir_CTLGUID_SynopsysWPPGuid;
WPP_d1108b5762de331776226394b50f9107_Traceguids;
WPP_db13989f244d3de882e5503f90c9d28b_Traceguids;
WPP_e3bd6714fb403abdce9a6935fbb1361d_Traceguids;
WPP_f303955e551e339ae3eb82be1932e801_Traceguids;
WPP_f46c91ce16d53a840dac864618b7f37f_Traceguids;
WPP_fdc5e781df6d3df56d03da80953e1213_Traceguids;
WdfBindInfo;
WdfDriverGlobals;
WdfFunctions_01015;
...
gCsNotifyCallback;
gEtwContext;
gIsIdleResiliencyEngaged;
gIsInConnectedStandby;
gPowerSettingCallbackHandle;
gWnfSubscriptionHandle;
load_config_used;
...
ActionFun_Detector_A_Cleanup();
ActionFun_Detector_A_Ignore();
Constructor_Detector();
CsNotifyWnfCallback();
DefaultQueueCreate();
...
DetectorCleanup();
DetectorTimer();
DeviceInterrupt_EvtAttachInterruptIsr();
DeviceInterrupt_EvtDetachInterruptIsr();
DeviceInterrupt_EvtInterruptDpc();
DeviceInterrupt_EvtInterruptIsr();
DriverEntry();
EndpointQueue_EvtIoStop();
EntryFun_Detector_Aca_Detecting_Detector();
EntryFun_Detector_CheckCharging_Detecting_Detector();
EntryFun_Detector_CheckDcd_Detecting_Detector();
EntryFun_Detector_DcpOrCdp2_Detecting_Detector();
EntryFun_Detector_DcpOrCdp_Detecting_Detector();
EntryFun_Detector_Detecting_Detecting_Detector();
EntryFun_Detector_Detecting_Stopped_Detector();
EntryFun_Detector_DisablingDcd_Detecting_Detector();
EntryFun_Detector_EnablingDcd_Detecting_Detector();
EntryFun_Detector_Stopped_Stopped_Detector();
EntryFun_Detector_Stopping_Stopped_Detector();
EtwUpdateDeviceHandle();
EventBufferHandleEvent();
EvtDisconnectTimer();
EvtEndpointCommandQueue();
FF_DetectorCheckChgDet();
FxDriverEntry();
FxDriverEntryWorker();
FxStubBindClasses();
FxStubDriverUnload();
...
HandleUsbConnectionDone();
HandleUsbDisconnect();
HandleUsbReset();
IdleResiliencySettingCallback();
...
McTemplateK0sssp();
McTemplateK0ttqtqq();
ProprietaryChargerAbortOperationWorkItem();
ProprietaryChargerCreateWorkItem();
ProprietaryChargerDetectWorkItem();
ProprietaryChargerEndOperation();
ProprietaryChargerEnqueueAbortOperation();
ProprietaryChargerInitialize();
ProprietaryChargerQuerySupport();
ProprietaryChargerReleaseInterface();
ProprietaryChargerResetOperationWorkItem();
ProprietaryChargerSetPropertyWorkItem();
ProprietaryChargerTryBeginOperation();
RegisterForCsNotifications();
RtlStringCchPrintfA();
RtlStringCchPrintfW();
SmfClonePackedSet();
SmfCreate();
...
SmfTraceStep();
SynopsysAbortGetAttachActionWorker();
SynopsysAcpiEvaluateDsmMethod();
SynopsysAcpiEvaluateMethod();
SynopsysAcpiGetPortType();
SynopsysAcpiGetVendorDeviceFlags();
SynopsysAcpiInitializeAttachAndPortDetect();
SynopsysAcpiNotificationEnabled();
SynopsysAcpiNotifyCallback();
SynopsysAcpiRegisterForNotification();
SynopsysAcpiSetDeviceState();
SynopsysAcpiSetPmuState();
SynopsysAcpiSoftCoreReset();
SynopsysAcpiUnregisterForNotification();
SynopsysAttachAbortOperation();
SynopsysAttachInterfaceEnqueueGetAttachAction();
SynopsysAttachInterfaceInitialize();
SynopsysAttachInterfaceQuery();
SynopsysAttachInterfaceSetDeviceState();
SynopsysCsNotifyCallback();
SynopsysDeviceCreate();
SynopsysDeviceEnterHibernation();
SynopsysDeviceExitHibernation();
SynopsysDeviceInitializeDefaultEndpoint();
SynopsysDevicePerformSoftReset();
SynopsysDeviceVendorReset();
SynopsysDevice_EvtDeviceCleanup();
SynopsysDevice_EvtDeviceD0Entry();
SynopsysDevice_EvtDeviceD0Exit();
SynopsysDevice_EvtDeviceD0ExitPreInterruptsDisabled();
SynopsysDevice_EvtDevicePrepareHardware();
SynopsysDevice_EvtDeviceReleaseHardware();
SynopsysDevice_EvtDeviceSurpriseRemoval();
SynopsysDevice_PopulateAcpiDeviceInformation();
SynopsysDevice_PopulateDeviceFlagsFromKse();
SynopsysDevice_PopulateEnumeratorInfo();
SynopsysDevice_PopulatePciDeviceInformation();
SynopsysDevice_RetrieveAcpiData();
SynopsysDevice_RetrievePciData();
SynopsysDevice_RetrieveUrsData();
SynopsysEtwLogConnectedStandbyInfo();
SynopsysEtwRundown();
SynopsysEvtProgramDma();
SynopsysEvtRequestCancel();
SynopsysGetAttachActionWorker();
SynopsysInterruptCreate();
SynopsysInterruptProgramEventBuffers();
SynopsysInterruptWatchdogTimer();
SynopsysRegistersCreate();
SynopsysTransferCommandEndComplete();
SynopsysTransferCommandStallClear();
SynopsysTransferCommandStallSet();
SynopsysTransferCommandStartComplete();
SynopsysTransferComplete();
SynopsysTransferCompleteNext();
SynopsysTransferDestroy();
SynopsysTransferGetStall();
SynopsysTransferInitialize();
SynopsysTransferNotReady();
SynopsysTransferReadyNotify();
SynopsysTransferRequestCancel();
SynopsysTransferReset();
SynopsysTransferStallClearComplete();
SynopsysTransferStallSetComplete();
SynopsysTransferStart();
SynopsysUfxDeviceCreate();
Synopsys_EvtDriverDeviceAdd();
Synopsys_EvtDriverUnload();
TransferAppendExtraTrb();
TransferBegin();
...
UfxDevice_EvtDeviceProprietaryChargerDetect();
UfxDevice_EvtDeviceProprietaryChargerReset();
UfxDevice_EvtDeviceProprietaryChargerSetProperty();
