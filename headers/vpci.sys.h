...
DeviceTextDefault;
DeviceTextDefault_buffer;
DeviceTextDisplay;
DeviceTextDisplay_buffer;
DeviceTextNetwork;
DeviceTextNetwork_buffer;
DeviceTextStorage;
DeviceTextStorage_buffer;
...
PnpBlocker;
PowerCallbackObj;
PowerCallbackRegistrationHandle;
SleepPageLock;
StateTable;
WDF_VPCI_FDO_CONTEXT_TYPE_INFO;
WDF_VPCI_PDO_CONTEXT_TYPE_INFO;
WDF_VPCI_PDO_PACKET_CONTEXT_TYPE_INFO;
WDF_VPCI_WORKITEM_CONTEXT_TYPE_INFO;
WPPTraceSuite;
WPP_1689bc6d44f835d782aa3bc5dbbd82ce_Traceguids;
WPP_3f3630012d8b3ff6dbc2ee61923cab2c_Traceguids;
WPP_GLOBAL_Control;
WPP_MAIN_CB;
WPP_ThisDir_CTLGUID_VpciDriverTraceGuid;
WPP_d928fde2c08b350dfb2ad8cc50b86954_Traceguids;
WdfBindInfo;
WdfDriverGlobals;
WdfFunctions_01015;
...
_IMPORT_DESCRIPTOR_vmbkmcl;
_IMPORT_DESCRIPTOR_winhv;
...
_imp_VmbChannelSendSynchronousRequest;
_imp_VmbChannelSetPointer;
_imp_VmbClientChannelInitSetRingBufferPageCount;
...
_imp_WinHvProcessorNumberToVpIndex;
...
_xmm;
_xmmffffffffffffffff0000000000000000;
g_MsiNextProc;
load_config_used;
...
vmbkmcl_NULL_THUNK_DATA;
winhv_NULL_THUNK_DATA;

AssignedResourcesCompletion();
DriverEntry();
FdoCreateVmbusChannel();
FdoDestroyVmbusChannel();
FdoDeviceAdd();
FdoDeviceCleanup();
FdoDeviceDestroy();
FdoEjectPdo();
FdoInvalidateBlockIndicate();
FdoInvalidateBlockMessage();
FdoInvalidateBlockWorker();
FdoProtocolCommunication();
FdoReadConfig();
FdoReferenceChildBySlot();
FdoReportDevices();
FdoSimplePdoMessage();
FdoWriteConfig();
FxDriverEntry();
...
GetCompletionStatus();
GetInterruptConnectionData();
GetMessagePolicy();
PdoAppendMsiRequirements();
PdoAssignedResourcesWorkItem();
PdoCheckReadWriteQueue();
PdoCompleteSelfSentPnpIrp();
PdoCompleteSyncIrp();
PdoContextCleanup();
PdoContextDestroy();
PdoCreate();
...
PdoD0Exit();
PdoDeviceEject();
PdoDisableInterrupts();
PdoFreePnpIrp();
PdoGetMessageCount();
PdoGetRegistryValue();
PdoIoctlReadBlock();
PdoIoctlWriteBlock();
PdoPowerStateCompletion();
PdoPowerWorkItem();
PdoPrepareHardware();
PdoPreprocessPnp();
PdoPreprocessPower();
PdoPreprocessReadWriteConfig();
PdoProgramInterrupts();
PdoProgramMsiInterrupt();
PdoProgramMsiXInterrupt();
PdoQueryResourceRequirements();
PdoQueryResources();
PdoReadBlockCompletion();
PdoReleaseHardware();
PdoRunStateMachine();
PdoSaveRawAndTranslatedResources();
PdoScanPciCapabilities();
PdoSelfSendIrpSendWorkItem();
PdoSelfSendPnpIrp();
PdoSelfSentIrpCompletionWorkItem();
PdoSendAssignedResourcesMessage();
PdoSendEjectionComplete();
PdoSendPowerMessage();
PdoSendQueryStopFailed();
PdoSendReleaseResourcesMessage();
PdoSendSelfIoControl();
PdoUpdateInterruptTranslations();
PdoWriteBlockCompletion();
PnpBlockerAnnounceBlockingIsReadyWorker();
PnpBlockerBroadcastBlockingIsReady();
PnpBlockerInit();
PnpBlockerInitRequestor();
PnpBlockerStartBlocking();
PnpBlockerStopBlocking();
RtlStringCchPrintfW();
RtlUnicodeStringInit();
RtlUnicodeStringPrintf();
VpciAddResourceRequirements();
VpciChannelClosed();
VpciCompletionBufferCreate();
VpciD0Entry();
VpciD0Exit();
VpciDereferenceInterface();
VpciDeviceListIdentificationDescriptionCleanup();
VpciDeviceListIdentificationDescriptionCompare();
VpciDeviceListIdentificationDescriptionDuplicate();
VpciDriverUnload();
VpciEvtChannelProcessPacket();
VpciGetBusData();
VpciGetDmaAdapter();
VpciGetTableEntry();
VpciGetTableSize();
VpciInternalIoControl();
VpciMaskTableEntry();
VpciPacketCreate();
VpciPacketDestroy();
VpciPowerStateCallback();
VpciPrepareHardware();
VpciReadConfigBlock();
VpciReferenceInterface();
VpciReleaseHardware();
VpciRemoveAddedResources();
VpciSelfManagedIoFlush();
VpciSetBusData();
VpciSetTableEntry();
VpciTranslateBusAddress();
VpciUnmaskTableEntry();
VpciWriteConfigBlock();
WPP_RECORDER_SF_();
WPP_RECORDER_SF_D();
WPP_RECORDER_SF_DDq();
WPP_RECORDER_SF_Dq();
...
WPP_RECORDER_SF_qLD();
WPP_RECORDER_SF_qLL();
WPP_RECORDER_SF_qLLLqq();
WPP_RECORDER_SF_qLl();
WPP_RECORDER_SF_qLq();
WPP_RECORDER_SF_qLqq();
WPP_RECORDER_SF_qd();
WPP_RECORDER_SF_qdqdd();
WPP_RECORDER_SF_qidqq();
WPP_RECORDER_SF_ql();
WPP_RECORDER_SF_qq();
WPP_RECORDER_SF_qqD();
WPP_RECORDER_SF_qqd();
