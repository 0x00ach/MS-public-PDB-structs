struct ACPI_CPC;
struct ACPI_CSD_STATE;
struct ACPI_CST;
struct ACPI_CST_STATE;
struct ACPI_CTRL_STATUS;
struct ACPI_LPI;
struct ACPI_LPI_STATE;
struct ACPI_PCCP;
struct ACPI_PROCESSOR_CONTAINERS;
struct ACPI_PSS;
struct ACPI_PSS_STATE;
struct ACPI_TSS;
struct ACPI_TSS_STATE;
struct ACPI_xSD;
struct ACPI_xSD_STATE;
...
struct LIST_ENTRY32;
struct LIST_ENTRY64;
struct MWAIT_CONTEXT;
struct OSC_INPUT_BUFFER;
struct OSC_OUTPUT_BUFFER;
struct PDC_INPUT_BUFFER;
struct PEPHANDLE__;
struct POHANDLE__;
struct PPM_DRIVER_INTERFACE;
...
struct _ACPI_PROCESSOR_CONTAINER;
struct _ACTIVATION_CONTEXT;
struct _ACTIVATION_CONTEXT_DATA;
struct _ACTIVATION_CONTEXT_STACK;
struct _ASSEMBLY_STORAGE_MAP;
struct _AUX_ACCESS_DATA;
struct _CAP_LOG_STATE;
struct _CLIENT_ID;
...
struct _CPC_REGISTER_DEFINITION;
struct _CPC_RUNTIME_STATE;
struct _CURDIR;
...
struct _DEVPROPKEY;
struct _DIFFERENTIAL_FEEDBACK_STATE;
...
struct _FAST_MUTEX;
struct _FDO_DATA;
struct _FEEDBACK_RUNTIME_STATE;
...
struct _IDLE_DOMAIN_ENTRY;
struct _IDLE_STATE_ENTRIES;
struct _IDLE_STATE_ENTRY;
...
struct _PCC_INTERFACE_INTERNAL;
struct _PCC_INTERFACE_STANDARD;
struct _PCC_RUNTIME_STATE;
struct _PCC_SUBSPACE_REGISTRATION;
struct _PEB;
...
struct _PEP_PERFORMANCE_STATE;
struct _PEP_PERF_RUNTIME_STATE;
struct _PEP_PLATFORM_IDLE_STATE;
struct _PEP_PPM_COORDINATED_LPI_STATE;
struct _PEP_PPM_IDLE_SELECT;
struct _PEP_PPM_LPI_COORDINATED_DEPENDENCY;
struct _PEP_PPM_LPI_COORDINATED_STATES;
struct _PEP_PPM_LPI_REGISTER;
struct _PEP_PPM_PARK_MASK;
struct _PEP_PPM_PARK_SELECTION_V2;
struct _PEP_PPM_QUERY_COORDINATED_DEPENDENCY;
struct _PEP_PPM_QUERY_IDLE_STATES;
struct _PEP_PPM_QUERY_IDLE_STATES_V2;
struct _PEP_PPM_QUERY_PLATFORM_STATE;
struct _PEP_PROCESSOR_FEEDBACK_COUNTER;
struct _PEP_PROCESSOR_IDLE_CONSTRAINTS;
struct _PEP_PROCESSOR_IDLE_DEPENDENCY;
struct _PEP_PROCESSOR_IDLE_STATE;
struct _PEP_PROCESSOR_IDLE_STATE_V2;
struct _PEP_PROCESSOR_PARK_PREFERENCE;
struct _PEP_PROCESSOR_PARK_STATE;
struct _PEP_PROCESSOR_PERF_STATE;
struct _PERFINFO_GROUPMASK;
struct _PERF_CONTROL_STATE_SELECTION;
struct _PERF_DOMAIN_ENTRY;
...
struct _PROC_ENERGY_COUNTER;
struct _PROC_ENERGY_ESTIMATION_COUNTERS;
struct _PROC_ENERGY_MODEL;
struct _PS_MITIGATION_AUDIT_OPTIONS_MAP;
struct _PS_MITIGATION_OPTIONS_MAP;
struct _PTSTATES_RUNTIME_STATE;
struct _QUAD;
...
struct _RUNTIME_IDLE_CONTEXT;
struct _RUNTIME_IDLE_STATE;
struct _RUNTIME_IDLE_STATES;
struct _RUNTIME_LPI_STATE;
struct _RUNTIME_PERF_STATE;
struct _RUNTIME_PERF_STATES;
...
typedef struct ACPI_CPC {
    ULONG NumberOfEntries;
    ULONG Revision;
    struct _GEN_ADDR HighestPerformance;
    struct _GEN_ADDR NominalPerformance;
    struct _GEN_ADDR LowestNonlinearPerformance;
    struct _GEN_ADDR LowestPerformance;
    struct _GEN_ADDR GuaranteedPerformance;
    struct _GEN_ADDR DesiredPerformance;
    struct _GEN_ADDR MinimumPerformance;
    struct _GEN_ADDR MaximumPerformance;
    struct _GEN_ADDR PerformanceReductionTolerance;
    struct _GEN_ADDR TimeWindow;
    struct _GEN_ADDR CounterWraparound;
    struct _GEN_ADDR NominalCounter;
    struct _GEN_ADDR DeliveredCounter;
    struct _GEN_ADDR PerformanceLimited;
    struct _GEN_ADDR Enable;
    struct _GEN_ADDR AutonomousEnable;
    struct _GEN_ADDR AutonomousActivityWindow;
    struct _GEN_ADDR EnergyPerformancePreference;
    struct _GEN_ADDR ReferencePerformance;
};

typedef struct ACPI_CSD_STATE {
    ULONG NumberOfEntries;
    ULONG Revision;
    ULONG DomainNumber;
    ULONG CoordinationType;
    ULONG MemberCount;
    ULONG Index;
};

typedef struct ACPI_CST {
    ULONG Count;
    struct ACPI_CST_STATE State[1];
};

typedef struct ACPI_CST_STATE {
...
typedef struct ACPI_CTRL_STATUS {
    struct _GEN_ADDR Control;
    struct _GEN_ADDR Status;
};

typedef struct ACPI_LPI {
    ULONG Revision;
    ULONG64 LevelId;
    ULONG Count;
    struct ACPI_LPI_STATE State[1];
};

typedef struct ACPI_LPI_STATE {
    ULONG MinimumResidency;
    ULONG WakeupLatency;
    ULONG Flags;
    union ACPI_LPI_ARCH_FLAGS ArchitectureFlags;
    ULONG ResidencyCounterFrequency;
    ULONG EnabledParentState;
    struct _GEN_ADDR EntryMethod;
    struct _GEN_ADDR ResidencyCounter;
    struct _GEN_ADDR UsageCounter;
    struct _UNICODE_STRING StateName;
};

typedef struct ACPI_PCCP {
    ULONG InputBufferOffset;
    ULONG OutputBufferOffset;
};

typedef struct ACPI_PROCESSOR_CONTAINERS {
    ULONG Count;
    struct _ACPI_PROCESSOR_CONTAINER ProcessorContainers[1];
};

typedef struct ACPI_PSS {
    ULONG Count;
    struct ACPI_PSS_STATE State[1];
};

typedef struct ACPI_PSS_STATE {
    ULONG CoreFrequency;
    ULONG Power;
    ULONG Latency;
    ULONG BmLatency;
...
typedef struct ACPI_TSS {
    ULONG Count;
    struct ACPI_TSS_STATE State[1];
};

typedef struct ACPI_TSS_STATE {
    ULONG Percentage;
    ULONG Power;
    ULONG Latency;
    ULONG Control;
...
typedef struct ACPI_xSD {
    ULONG Count;
    struct ACPI_xSD_STATE State[1];
};

typedef struct ACPI_xSD_STATE {
    ULONG NumberOfEntries;
    ULONG Revision;
    ULONG DomainNumber;
    ULONG CoordinationType;
...
typedef struct GLOBALS {
    ULONG64 PPMCapabilities;
    ULONG64 PPMRegFlags;
    ULONG PPMOverrideFlags;
    ULONG ProcessorCount;
    struct WDFWAITLOCK__ *Mutex;
    struct WDFWAITLOCK__ *PepStateMutex;
    struct _LIST_ENTRY DeviceHead;
    struct _LIST_ENTRY PerfDomainHead;
    struct _LIST_ENTRY PackageHead;
    struct _LIST_ENTRY IdleDomainHead;
    struct _LIST_ENTRY PccHead;
    struct _KAFFINITY_EX ProcessorsAvailable;
    struct PPM_DRIVER_INTERFACE DrvInterface;
    struct _PPM_DRIVER_DISPATCH_TABLE PpmDispatchTable;
    struct _KAFFINITY_EX ProcessorsEnumerated;
    PLONG RegisterIdleStates;
    PLONG RegisterPStates;
    PLONG RegisterPerfCap;
    PLONG RegisterPerfFeedback;
    PLONG RegisterLegacyPcc;
    PLONG RegisterCpc;
    PLONG RegisterPepPerf;
    PLONG GetProcessorIndex;
    PLONG RegisterPackage;
    struct _EVENT_DESCRIPTOR *SummaryEvent;
    struct _EVENT_DESCRIPTOR *Summary2Event;
    struct _EVENT_DESCRIPTOR *IdleStatesErrorEvent;
    struct _EVENT_DESCRIPTOR *PerfStatesErrorEvent;
    struct _EVENT_DESCRIPTOR *ThrottleStatesErrorEvent;
    struct _EVENT_DESCRIPTOR *CapInfoEvent;
    UCHAR SyntheticPsdAllowed;
    enum {
        PerfStatesNative = 0,
        PerfStatesHvOnly = 1,
        PerfStatesHvShared = 2
    } PerfStatesOwner;
    ULONG HvDomainCount;
    struct _PCC_INTERFACE_INTERNAL PccInterfaceInternal;
    ULONG Errata;
    struct _PCC_INTERFACE_STANDARD PccInterface;
    struct _PCC_SUBSPACE_REGISTRATION *PccSubspace;
    ULONG PccRegisteredProcessors;
    PVOID PccCallback;
    struct WDFSPINLOCK__ *PccMutex;
    struct _IO_WORKITEM *PccCapWorker;
    ULONG PepRegisteredProcessors;
    UCHAR PccCapUpdated;
    UCHAR PccCapWorkerQueued;
    UCHAR AssertsDisabled;
    ULONG CoordinatedStateCount;
    struct _PLATFORM_IDLE_STATES *PlatformIdleStates;
    struct _COORDINATED_IDLE_STATES *CoordinatedStates;
    struct _COORDINATED_IDLE_STATES *LpiCoordinatedStates;
    PULONG LpiStateIndexMapping;
    struct _RUNTIME_LPI_STATE *LpiRuntimeState;
    struct ACPI_PROCESSOR_CONTAINERS *ProcessorContainers;
    struct _PREREGISTERED_VETO_LIST *VetoList;
    struct _IO_WORKITEM *StateUpdateWorker;
    UCHAR StateUpdateWorkerQueued;
    ULONG EfficiencyClasses;
    ULONG ProcessorCounts[2];
    struct _PROC_ENERGY_MODEL EnergyModels[2];
    ULONG EnergyEnabledProcessors;
    LONG64 QpcFrequency;
...
typedef struct MWAIT_CONTEXT {
    ULONG SubCState : 4;
    ULONG TargetCState : 4;
    ULONG Hints;
    ULONG EnableBreakEvent : 1;
    ULONG Extensions;
    ULONG64 HintsExtensions;
    ULONG64 MonitorAddress;
    union {
        ULONG HardwareCoordinated : 1;
        ULONG UseBmStatus : 1;
        ULONG Reserved : 29;
        ULONG AsULONG;
    } Flags;
...
typedef struct OSC_INPUT_BUFFER {
    struct _GUID UUID;
    ULONG Revision;
...
typedef struct OSC_OUTPUT_BUFFER {
    ULONG Capabilities[1];
};

typedef struct PDC_INPUT_BUFFER {
    ULONG Revision;
    ULONG CapabilitiesCount;
    ULONG Capabilities[1];
};
...
typedef struct PPM_DRIVER_INTERFACE {
    ULONG Version;
    ULONG Size;
    ULONG Flags;
    struct PDC_INPUT_BUFFER *PdcBiosData;
    struct OSC_INPUT_BUFFER *OscBiosData;
    USHORT PdcSize;
    USHORT OscSize;
    PLONG DeviceStart;
    PLONG InitializeAcpiIdleStates;
    PLONG DecodeVendorIdleState;
    PLONG ValidatePStates;
    PLONG SetPStateFFH;
    PLONG SetTStateFFH;
    PVOID PStateFeedBack;
    PVOID GetFFHThrottleState;
    PVOID BoostPolicyHandler;
    PVOID BoostModeHandler;
    PUCHAR CheckEfficientThrottle;
    PLONG ConnectNativeInterrupt;
    PLONG GetNativeCppcPerfControlHandler;
    PVOID EnableNativeInterrupt;
    PLONG InitEnergyCounters;
    PVOID UnInitEnergyCounters;
    PVOID ComputeEnergy;
    PVOID SnapEnergyCounters;
    ULONG PStateFFHControlRegister;
    ULONG64 PStateFFHControlMask;
    ULONG TStateFFHControlRegister;
    ULONG64 TStateFFHControlMask;
};
...
typedef struct WMI_EVENT {
    struct WDFWMIINSTANCE__ *Instance;
    ULONG DataSize;
    UCHAR Registered;
};
...
typedef struct _ACPI_CSD {
    ULONG Count;
    struct ACPI_CSD_STATE State[1];
};
...
typedef struct _ACPI_PROCESSOR_CONTAINER {
    struct _UNICODE_STRING NamespacePath;
    struct ACPI_LPI *LpiStates;
    ULONG ParentProcessorContainer;
    ULONG ChildProcessorCount;
    PULONG ChildProcessors;
};
...
typedef struct _CAP_LOG_STATE {
    struct _KTIMER Timer;
    struct _KDPC Dpc;
    union _LARGE_INTEGER CapDuration;
    ULONG PpcChanges;
    ULONG TpcChanges;
    ULONG PccCapChanges;
    UCHAR TimerQueued;
...
typedef struct _CPC_REGISTER_DEFINITION {
    ULONG Offset;
    PCHAR Name;
    UCHAR Static;
    UCHAR Null;
...
typedef struct _CPC_RUNTIME_STATE {
    ULONG64 HighestPerformance;
    ULONG64 NominalPerformance;
    ULONG64 LowestNonlinearPerformance;
    ULONG64 LowestPerformance;
    ULONG64 ReferencePerformance;
    ULONG64 SelectedPerformance;
    ULONG64 GuaranteedPerformance;
    ULONG NominalFrequency;
    ULONG HighestPercent;
    ULONG HighestObservedHighestPercent;
    ULONG LowestNonlinearPercent;
    ULONG LowestPercent;
    ULONG GuaranteedPercent;
    ULONG CachedPercentFrequency;
    UCHAR EnablePresent;
    UCHAR DesiredPresent;
    UCHAR MinimumPresent;
    UCHAR MaximumPresent;
    UCHAR EppPresent;
    UCHAR ActivityWindowPresent;
    UCHAR PerformanceReductionTolerancePresent;
    UCHAR GuaranteedPerformancePresent;
    UCHAR PccUsedForRead;
    UCHAR PccUsedForGuaranteedNotify;
    UCHAR PccUsedForHighestNotify;
    UCHAR PccUsedForWrite;
    UCHAR NativeInterruptEnabled;
    UCHAR SingleRegisterInitialized;
    UCHAR PackageRegisterInitialized;
    struct ACPI_CPC *Cpc;
    struct _GEN_ADDR SingleRegisterAddress;
    ULONG64 CachedRegisterValue;
    ULONG64 SingleRegisterMask;
    ULONG64 CachedPackageValue;
    struct _DIFFERENTIAL_FEEDBACK_STATE DeliveredFeedback;
    struct _DIFFERENTIAL_FEEDBACK_STATE HardwareFeedback;
    struct _KDPC NativeInterruptDpc;
    struct _IO_WORKITEM *NativeInterruptWorker;
    LONG NativeInterruptWork;
};
...
typedef struct _DIFFERENTIAL_FEEDBACK_STATE {
    ULONG64 LastActualCount;
    ULONG64 LastReferenceCount;
    ULONG64 CumulativeActualCount;
    ULONG64 CumulativeReferenceCount;
    ULONG64 ActualMask;
    ULONG64 ReferenceMask;
    PVOID FeedbackRoutine;
    PVOID Context;
};
...
typedef struct _FDO_DATA {
    ...
    struct WDFIOTARGET__ *DefaultTarget;
    struct _FILE_OBJECT *FileObject;
    struct _LIST_ENTRY DeviceLink;
    ULONG InitialApicID;
    ULONG AcpiID;
    ULONG NtNumber;
    PWCHAR BiosDeviceName;
    ULONG LpIndex;
    UCHAR ResumeFromSleep;
    UCHAR Revision;
    UCHAR Spare[1];
    struct OSC_OUTPUT_BUFFER *OscOutput;
    struct _ACPI_INTERFACE_STANDARD AcpiInterfaces;
    struct _GEN_ADDR PBlkAddress;
    ULONG64 MonitorAddress;
    struct WDFWAITLOCK__ *AcpiObjectLock;
    struct _PTSTATES_RUNTIME_STATE *PTStatesRuntimeState;
    struct _FEEDBACK_RUNTIME_STATE *FeedbackRuntimeState;
    struct _PCC_RUNTIME_STATE *PccRuntimeState;
    struct _CPC_RUNTIME_STATE *CpcRuntimeState;
    ULONG64 DrvCapabilities;
    ULONG64 PPMFound;
    ULONG64 PPMEnabled;
    ULONG PPMFeatureFlags;
    PLONG SetPState;
    PLONG SetTState;
    PVOID PStateFeedback;
    PVOID GetFFHThrottleState;
    PVOID SetBoostPolicy;
    PVOID SetBoostMode;
    struct _PROC_ENERGY_ESTIMATION_COUNTERS *EstimationCounters;
    UCHAR EfficiencyClass;
    ULONG64 HighestPerformance;
    ULONG64 NominalPerformance;
    ULONG64 LowestNonlinearPerformance;
    ULONG64 LowestPerformance;
    struct ACPI_CTRL_STATUS PCT;
    struct ACPI_PSS *PSS;
    struct ACPI_PSS *XPSS;
    ULONG PPC;
    struct ACPI_xSD *PSD;
    struct ACPI_CTRL_STATUS PTC;
    struct ACPI_TSS *TSS;
    ULONG TPC;
    struct ACPI_xSD *TSD;
    struct ACPI_CST *CST;
    struct _ACPI_CSD *CSD;
    struct ACPI_LPI *LPI;
    struct ACPI_xSD *XSD;
    struct _PERF_DOMAIN_ENTRY *PerfDomain;
    struct _LIST_ENTRY PerfDomainLink;
    struct ACPI_PCCP *Pccp;
    struct ACPI_CPC *CPC;
    struct _WMILIB_CONTEXT WmiLibInfo;
    struct WMI_EVENT AcpiNotify80;
    struct WMI_EVENT AcpiNotify81;
    struct WMI_EVENT AcpiNotify82;
    struct _RUNTIME_IDLE_STATES *RuntimeIdleStates;
    UCHAR IdleStatesInitilized;
    struct _IDLE_STATE_ENTRIES *IdleStateEntries;
    ULONG ThermalCap;
    ULONG PccCap;
    union _LARGE_INTEGER CapStart;
    union _LARGE_INTEGER CapDuration;
    ULONG PpcChanges;
    ULONG TpcChanges;
    ULONG PccCapChanges;
    struct _CAP_LOG_STATE CapQuickLog;
    struct _CAP_LOG_STATE CapLongLog;
    struct _PROCESSOR_PACKAGE *Package;
    struct _LIST_ENTRY PackageLink;
    ULONG FeaturesPresent;
    ULONG FeaturesAccessed;
    ULONG FeaturesInvalidated;
    struct POHANDLE__ *FxHandle;
    ULONG PepFeedbackCounterCount;
    ULONG PepIdleStateCount;
    UCHAR PepPerfStateCount;
    UCHAR PepPerformanceSupported;
    UCHAR PepParkingSupported;
    struct _PEP_PPM_QUERY_IDLE_STATES *PepIdleStates;
    struct _PEP_PPM_QUERY_IDLE_STATES_V2 *PepIdleStatesV2;
    struct _UNICODE_STRING *IdleStateNames;
    struct _IO_WORKITEM *IdleStateUpdateWorkItem;
    UCHAR IdleStatesWorkerQueued;
    UCHAR IdleStateUpdates;
    LONG PerformanceStateWorkerQueued;
    struct _IO_WORKITEM *PerformanceStateUpdateWorkItem;
    struct _PEP_PERFORMANCE_STATE *PepPerfStates;
    struct _PEP_PERF_RUNTIME_STATE *PepPerfRuntimeState;
    struct ACPI_xSD *PepDomain;
};

typedef struct _FEEDBACK_RUNTIME_STATE {
    struct _DIFFERENTIAL_FEEDBACK_STATE HardwareFeedback;
    ULONG NominalFrequency;
};
...
typedef struct _IDLE_DOMAIN_ENTRY {
    struct _LIST_ENTRY Link;
    struct _LIST_ENTRY IdleStateHead;
    ULONG Count;
    ULONG Id;
    ULONG Coordination;
    ULONG Total;
    struct _KAFFINITY_EX Mask;
};

typedef struct _IDLE_STATE_ENTRIES {
    ULONG Count;
    struct _IDLE_STATE_ENTRY State[1];
};

typedef struct _IDLE_STATE_ENTRY {
    struct ACPI_CST_STATE *CstState;
    struct _IDLE_DOMAIN_ENTRY *IdleDomain;
    struct _LIST_ENTRY Link;
};
...
typedef struct _PCC_INTERFACE_INTERNAL {
    USHORT Size;
    USHORT Version;
    PVOID Context;
    PVOID InterfaceReference;
    ...
    struct _GEN_ADDR Doorbell;
};

typedef struct _PCC_INTERFACE_STANDARD {
    USHORT Size;
    USHORT Version;
    PVOID Context;
    PVOID InterfaceReference;
    ...
    PLONG AcquireSubspace;
    PLONG AcquireSubspaceAsync;
    PLONG ExecuteCommand;
    PLONG ExecuteCommandAsync;
    PLONG ReleaseSubspace;
};

typedef struct _PCC_RUNTIME_STATE {
    struct _LIST_ENTRY Link;
    ULONG TargetFrequency;
    ULONG ActualFrequency;
    struct _PCC_INPUT_BUFFER *InputBuffer;
    union _PCC_OUTPUT_BUFFER *OutputBuffer;
    ULONG Cap;
    struct _FDO_DATA *DevExt;
};

typedef struct _PCC_SUBSPACE_REGISTRATION {
    struct _PCC_INTERFACE_STANDARD PccInterface;
    struct WDFSPINLOCK__ *Mutex;
    PVOID RuntimeCallback;
    ULONG64 RuntimeContext;
};
...
typedef struct _PEP_PERFORMANCE_STATE {
    ...
    ULONG LowestPercent;
    UCHAR StateCount;
    struct _PEP_PROCESSOR_PERF_STATE *States;
    ULONG FrequencyCounterIndex;
    ULONG PerformanceCounterIndex;
    struct _PEP_PROCESSOR_FEEDBACK_COUNTER FeedbackCounters[1];
};

typedef struct _PEP_PERF_RUNTIME_STATE {
    struct _PEP_PERFORMANCE_STATE *PepState;
    struct POHANDLE__ *FxHandle;
    ULONG LimitReasons;
    ULONG GuaranteedPerformance;
    ULONG GuaranteedPercent;
    ULONG TimeWindow;
};

typedef struct _PEP_PLATFORM_IDLE_STATE {
    struct POHANDLE__ *InitiatingProcessor;
    PVOID DeviceContext;
    UCHAR InitiatingState;
    ULONG Latency;
    ...
    struct _PEP_PROCESSOR_IDLE_DEPENDENCY DependencyArray[1];
};
...
typedef struct _PEP_PPM_COORDINATED_LPI_STATE {
    ...
    ULONG ResidencyCounterFrequency;
    UCHAR IntegerEntryMethod;
    union {
        struct _PEP_PPM_LPI_REGISTER AsRegister;
        ULONG64 AsInteger;
    } EntryMethod;
    struct _PEP_PPM_LPI_REGISTER ResidencyCounter;
    struct _PEP_PPM_LPI_REGISTER UsageCounter;
    PWCHAR StateName;
    ULONG DependencyCount;
    struct _PEP_PPM_LPI_COORDINATED_DEPENDENCY *Dependencies;
};

typedef struct _PEP_PPM_IDLE_SELECT {
    struct _PEP_PROCESSOR_IDLE_CONSTRAINTS *Constraints;
    UCHAR AbortTransition;
    ULONG IdleStateIndex;
    ULONG DependencyArrayUsed;
    ULONG DependencyArrayCount;
    struct _PEP_PROCESSOR_IDLE_DEPENDENCY *DependencyArray;
    ULONG PlatformIdleStateIndex;
};

typedef struct _PEP_PPM_LPI_COORDINATED_DEPENDENCY {
    struct PEPHANDLE__ *TargetProcessor;
    PVOID KernelContext;
    ULONG OptionCount;
    PULONG Options;
};
...
typedef struct _PEP_PPM_LPI_COORDINATED_STATES {
    ULONG Count;
    struct _PEP_PPM_COORDINATED_LPI_STATE LpiStates[1];
};
...
typedef struct _PEP_PPM_PARK_MASK {
    ULONG Count;
    ULONG64 EvaluationTime;
    struct _PEP_PROCESSOR_PARK_STATE *Processors;
};

typedef struct _PEP_PPM_PARK_SELECTION_V2 {
    ULONG AdditionalUnparkedProcessors;
    ULONG Count;
    struct _PEP_PROCESSOR_PARK_PREFERENCE *Processors;
    ULONG64 EvaluationTime;
...
typedef struct _PEP_PPM_QUERY_COORDINATED_DEPENDENCY {
    ...
    struct POHANDLE__ *TargetProcessor;
    PVOID DeviceContext;
    struct _PEP_COORDINATED_DEPENDENCY_OPTION Options[1];
};

typedef struct _PEP_PPM_QUERY_IDLE_STATES {
    ULONG Count;
    ULONG MaximumCoordinatedProcessors;
    struct _PEP_PROCESSOR_IDLE_STATE IdleStates[1];
};

typedef struct _PEP_PPM_QUERY_IDLE_STATES_V2 {
    ULONG Count;
    struct _PEP_PROCESSOR_IDLE_STATE_V2 IdleStates[1];
};

typedef struct _PEP_PPM_QUERY_PLATFORM_STATE {
    ULONG StateIndex;
    struct _PEP_PLATFORM_IDLE_STATE State;
};
...
typedef struct _PEP_PROCESSOR_IDLE_CONSTRAINTS {
    ULONG64 IdleDuration;
    UCHAR Interruptible;
    enum PEP_PROCESSOR_IDLE_TYPE Type;
};
...
typedef struct _PEP_PROCESSOR_PARK_PREFERENCE {
    struct PEPHANDLE__ *Processor;
    struct POHANDLE__ *KernelContext;
    UCHAR PoPreference;
    UCHAR PepPreference;
};
...
typedef struct _PERF_DOMAIN_ENTRY {
    struct _LIST_ENTRY Link;
    struct _LIST_ENTRY DevExtHead;
    ULONG Count;
    ULONG Id;
    ULONG Coordination;
    ULONG Total;
...
typedef struct _PROCESSOR_PACKAGE {
    struct _LIST_ENTRY Link;
    struct _LIST_ENTRY DevExtHead;
    struct _KAFFINITY_EX Members;
    ULONG Id;
...
typedef struct _PROC_ENERGY_COUNTER {
    ULONG CounterId;
    enum _KPROFILE_SOURCE ProfileSource;
    ULONG CounterType;
    ULONG MachineSpecificCounter : 1;
    ULONG Reserved : 15;
    ULONG CounterDescriptor : 16;
    ULONG FactorDWord;
    FLOAT FactorFloat;
};

typedef struct _PROC_ENERGY_ESTIMATION_COUNTERS {
    ULONG NumberOfActiveCounters;
    PVOID PmcHandle;
    struct {
        ULONG64 CurrentValue;
        ULONG64 PreviousValue;
        ULONG64 SnappedValue;
    } CounterState[4];
};

typedef struct _PROC_ENERGY_MODEL {
    ULONG PowerEnvelope;
    ULONG PowerCurveMetadata;
    ULONG UsePowerCurve : 1;
    ULONG PointCount : 7;
    ULONG Reserved : 24;
    union _PROC_POWER_COORDINATES PowerCurve[8];
    ULONG NumberOfCounters;
    struct _PROC_ENERGY_COUNTER EnergyCounters[16];
    PVOID ComputeEnergy;
    PVOID SnapEnergyCounters;
};
...
typedef struct _PTSTATES_RUNTIME_STATE {
    ULONG CurrentType;
    ULONG CurrentPercentFrequency;
    ULONG TargetState;
    struct _RUNTIME_PERF_STATES *PerfStates;
    struct _DIFFERENTIAL_FEEDBACK_STATE HardwareFeedback;
};
...
typedef struct _RUNTIME_IDLE_CONTEXT {
    struct _GEN_ADDR Register;
    struct MWAIT_CONTEXT MwaitContext;
};

typedef struct _RUNTIME_IDLE_STATE {
    struct ACPI_CST_STATE *CstState;
    struct _IDLE_DOMAIN_ENTRY *IdleDomain;
    PLONG Check;
    PVOID Handler;
    struct _RUNTIME_IDLE_CONTEXT Context;
    ULONG64 CompositionContext;
    PVOID ContextDecode;
    struct _IDLE_STATE_ENTRY *IdleStateEntry;
    UCHAR Native;
    UCHAR Autonomous;
    UCHAR CStateType;
};

typedef struct _RUNTIME_IDLE_STATES {
    struct POHANDLE__ *FxHandle;
    ULONG SelectedState;
    ULONG TargetState;
    ULONG PreferredState;
    UCHAR PreferredStateCount;
    UCHAR PreferredStates[3];
    ULONG64 IdleTime;
    ULONG64 TotalTime;
    ULONG MaximumDependencies;
    struct _PEP_PROCESSOR_IDLE_DEPENDENCY *DependencyArray;
    ULONG Count;
    struct _RUNTIME_IDLE_STATE State[1];
};

typedef struct _RUNTIME_LPI_STATE {
    PVOID Handler;
    struct _RUNTIME_IDLE_CONTEXT Context;
    ULONG64 CompositionContext;
    PVOID ContextDecode;
...
typedef struct _RUNTIME_PERF_STATE {
    ULONG64 Control;
    ULONG64 Status;
    ULONG Frequency;
    ULONG Power;
...
typedef struct _RUNTIME_PERF_STATES {
    PLONG PStateHandler;
    PLONG TStateHandler;
    ULONG64 PStateContext;
    ULONG64 TStateContext;
    struct _RUNTIME_PERF_STATE *States;
    ULONG StateCount;
    ULONG PStateCount;
    ULONG TStateCount;
};
...
typedef union ACPI_LPI_ARCH_FLAGS {
    ULONG ContextLost : 1;
    ULONG Reserved : 31;
    ULONG AsULong;
};
...
typedef union _HV_X64_PPM_IDLE_STATE_CONFIG {
    ULONG64 AsUINT64;
    ULONG64 TypeSpecific : 52;
    ULONG64 ChangeType : 4;
    ULONG64 CheckBM_STS : 1;
    ULONG64 SetBM_RST : 1;
    ULONG64 ClearBM_RST : 1;
    ULONG64 SetARB_DIS : 1;
    ULONG64 ReservedZ : 4;
    struct {
        ULONG64 ReservedZ : 52;
    } Hlt;
    struct {
        USHORT Port;
        USHORT ReservedZ1;
    ...
    struct {
        ULONG Hints;
        ULONG BreakOnMaskedInterrupt : 1;
        ULONG ReservedZ : 19;
    } Mwait;
};
...
typedef union _PROC_POWER_COORDINATES {
    ULONG PowerCoordinates;
    ULONG FrequencyPercent : 8;
    ULONG PowerEnvelope : 24;
};
...
typedef enum PEP_PROCESSOR_IDLE_TYPE {
    PepIdleTypeProcessor = 0,
    PepIdleTypePlatform = 1,
    PepIdleTypeMax = 2
};
...
ACPI_OSC_INTEL_GUID;
AcpiFeatureMethods;
AcpiGenericAccessSizeTranslation;
AcpiInfo;
CounterId;
Cpc2RegisterTable;
CpcRegisterTable;
...
DevExts;
EnergyModelContext;
Feature_HwpAllowFastMsrOptimizations__private_propertyCache;
Feature_HwpAllowFastMsrOptimizations_logged_traits;
Feature_HwpAllowQosIdleOptimizations__private_propertyCache;
Feature_HwpAllowQosIdleOptimizations_logged_traits;
GUID_ACPI_INTERFACE_STANDARD;
GUID_DEVINTERFACE_THERMAL_COOLING;
GUID_EM_RULE_DISABLE_ACPI1_CSTATE_C2;
GUID_EM_RULE_DISABLE_PCC;
GUID_EM_RULE_DISABLE_PSTATES;
GUID_EM_RULE_DISABLE_TSTATES;
...
HgsInterruptSupported;
HwpHighestInterruptSupported;
HwpNotificationInterruptSupported;
OscBuffer;
...
PPM_ETW_IDLE_STATES_ERROR;
PPM_ETW_IDLE_STATES_ERROR_HV;
PPM_ETW_LONG_CAP_INFO;
PPM_ETW_LONG_CAP_INFO_HV;
PPM_ETW_NOTIFY_80;
PPM_ETW_NOTIFY_81;
PPM_ETW_NOTIFY_82;
PPM_ETW_NOTIFY_85;
...
PPM_ETW_PEP_PERF_DOMAIN_INFO;
PPM_ETW_PEP_PERF_DOMAIN_INFO_RUNDOWN;
...
PPM_ETW_PERF_STATES_ERROR;
PPM_ETW_PERF_STATES_ERROR_HV;
...
PPM_ETW_THROTTLE_STATES_ERROR;
PPM_ETW_THROTTLE_STATES_ERROR_HV;
...
PepLpiInitialized;
PepParkLists;
PepPlatformStatesQueried;
PepSkipParkNotification;
PepSkipPerfCheckNotification;
PepSpmHandleQueried;
PlatformStatesRegistered;
ProcBmRldSet;
ProcLibEtwHandle;
ProcLibEtwRegistered;
ProcessorBiosCStates_GUID;
ProcessorBiosInfo_GUID;
ProcessorBiosTStates_GUID;
ProcessorCStateEvent_GUID;
ProcessorPerfStateEvent_GUID;
ProcessorStatus_GUID;
ProcessorThrottleStateEvent_GUID;
TraceLoggingMetadata;
TraceLoggingMetadataEnd;
UnexpectedTurboDisableReported;
WDF_FDO_DATA_TYPE_INFO;
WPPTraceSuite;
WPP_079bbb48f67639f170f28876308ce3ee_Traceguids;
WPP_15b16aaf01ba346f37f33139b3211597_Traceguids;
WPP_2c93596d227b365fe96486fd941e48d7_Traceguids;
WPP_30065b99cb4a32253e6076e5eda4c6d3_Traceguids;
WPP_34a4022a10a23463488b8657e85abd31_Traceguids;
WPP_59812b689cd0301398adc603ff5c4ec4_Traceguids;
WPP_63eae363b5c33513270082e271b1e7f4_Traceguids;
WPP_6e1776dc04963c03796a3f3bc22ab750_Traceguids;
WPP_885f9b737e553b3972faa1b865470758_Traceguids;
WPP_97dad236fc94352450bb5a824c78072d_Traceguids;
WPP_9c9bb0b09fed3dc32d9c2200880966f2_Traceguids;
WPP_GLOBAL_Control;
WPP_MAIN_CB;
WPP_ThisDir_CTLGUID_ProcessorDriverTraceGuid;
WPP_aa9d9c6c8741343c67d4469f91515e40_Traceguids;
WPP_b538b38e7b6a388d39fd05bc744c7ccf_Traceguids;
WPP_c5c7ce996b8d3bf3de21e73d0ef31f21_Traceguids;
WPP_cba184944e253c33dd425163d97fc505_Traceguids;
WPP_d667f905f354316575e92a3c62754286_Traceguids;
WPP_eb7b501de93c334997b4c3503e72e86c_Traceguids;
WPP_efe3bcbd9fba319583ae282d013a539b_Traceguids;
WPP_fd5514c76d4730a223eb6514052d63dc_Traceguids;
WdfBindInfo;
WdfDriverGlobals;
WdfFunctions_01015;
...
_imp_HvlGetLpIndexFromApicId;
_imp_HvlQueryActiveHypervisorProcessorCount;
_imp_HvlQueryActiveProcessors;
_imp_HvlQueryProcessorTopology;
_imp_HvlReadPerformanceStateCounters;
...
_imp_PoEnergyEstimationEnabled;
_imp_PoFxActivateComponent;
_imp_PoFxProcessorNotification;
...
AcpiCStateIdleExecute();
AcpiCStateIdlePrepare();
AcpiCStateInitiateWake();
AcpiCStateIsHalted();
AcpiCStateLegacySelect();
AcpiCStateNotifyWorker();
AcpiCppcGuaranteedNotifyWorker();
AcpiCppcHighestNotifyWorker();
AcpiEval_CPC();
AcpiEval_CSD();
AcpiEval_CST();
AcpiEval_OSC();
...
AcpiEval_XPSS();
AcpiEvaluateMethod();
AcpiGetCoordinatedLpiStates();
AcpiNotifyCallback();
AcpiOSCNotifyWorker();
AcpiPStateNotifyWorker();
AcpiParseAnsiString();
AcpiParseCore();
AcpiParseLpiObject();
AcpiParseProcessorContainer();
AcpiParseRegister();
AcpiParseRegisterOrQword();
AcpiParseStaticRegister();
AcpiParseULong();
AcpiParseULong64();
AcpiTStateNotifyWorker();
AcpiTranslateAccessSize();
AcquireAcpiInterfaces();
AcquireBiosPpmControl();
AcquirePccInterface();
AcquirePccSubspace();
ActivateFixedFunctionCounters();
C1Halt();
C1Idle();
C2Idle();
C3Idle();
C3IdleCheck();
CalculatePercentageCap();
CapLogWorker();
CollectAcpiBiosInfo();
ComputeEnergyDispatch();
ComputePowerEnvelopeFromCurve();
ComputeProcessorEnergy();
ComputeProcessorEnergyMsr();
ComputeProcessorEnergyMsrEx();
ConnectHwpInterrupt();
CpcAcquirePerformance();
CpcAcquirePerformanceCallback();
CpcCommitPerformance();
CpcCommitPerformanceCallback();
CpcConnectNativeInterrupt();
CpcGuaranteedNotifyWorker();
CpcHighestNotifyWorker();
CpcNativeInterruptDpc();
CpcNativeInterruptOccurred();
CpcNativeInterruptWorker();
CpcReadFeedback();
CpcReadFeedbackAcquireCallback();
CpcReadFeedbackExecuteCallback();
CpcRegisterIsSupported();
CpcReinitializeHandler();
CpcSetAutonomousActivityWindow();
CpcSetAutonomousMode();
CpcSetTimeWindow();
DeactivateFixedFunctionCounters();
DecodeAcpi2CState();
DecodeAcpiIdleState();
DecodeAcpiPStates();
DecodeAcpiTStates();
DecodeControlStatusRegisterIo();
DecodeDoorbellAddressIo();
DecodeGenAddressToHvPerfReg();
DecodeMWaitContext();
DecodeMWaitIdleState();
DecodeRegisterContext();
DeregisterIdleDomain();
DeregisterKernelIdleDomains();
DisableEnergyEstimation();
DisplayGenAddr();
DisplayKernelIdleStates();
DisplayKernelPerfStates();
DisplayPPMFlags();
Display_CPC();
Display_CSD();
Display_CST();
...
Display_xSD();
DriverEntry();
EnableEnergyEstimation();
EnableHwpInterrupt();
EnablePerformanceMonitoringCounters();
...
GetGenAddrType();
GetHvPackage();
GetHvPpmCapabilities();
GetHwpPerfControlHandler();
GetLpIndex();
GetNtProcessorNumber();
GetObjectTypeName();
GetPackageAffinity();
GetPackedName();
GetPccInternalInterfaceInfo();
GetPerfDomain();
GetProcessorArchitectureIndex();
GetProcessorEfficiencyClass();
GetProcessorStatusInfo();
GetRegistryDwordValue();
GetRegistryDwordValueNoDefault();
GetRegistryQwordValue();
GetWmiBiosIdleStateInfo();
GetWmiBiosInfoV1();
GetWmiBiosThrottleStateInfo();
HviIsAnyHypervisorPresent();
HwpInterruptService();
InitAcpi1CStates();
InitAcpi1ThrottleStates();
InitAcpi2CStates();
InitAcpi3ThrottleStates();
InitAcpiCStates();
InitAcpiCpc();
InitAcpiIdleDomain();
InitAcpiIdleStateSupport();
InitAcpiLegacyPcc();
InitAcpiLpiStates();
InitAcpiPerfDomain();
InitAcpiPerfStates();
InitAcpiProcessorDomains();
InitAcpiThrottleDomain();
InitAcpiThrottleStates();
InitCpcStatesInternal();
InitDevExts();
InitDriver();
InitEnergyCounters();
InitEnergyCountersMsr();
InitEnergyCountersMsrEx();
InitLegacyPccInternal();
InitMonitorMWaitSupport();
InitPep();
InitPepIdleStates();
InitPepPerfStates();
InitPepProcessorDomain();
InitPerfFeedbackInternal();
InitPerfStatesInternal();
InitializeEnergyEstimation();
InitializeEnergyEstimationForEfficiencyClass();
InitializeEnumerationContext();
InitializeSingleEnumerationContext();
InvokePTStateChange();
IoHaltC1Idle();
IsCppcThrottleEfficient();
IsHgsInterruptSupported();
IsHwpFastMsrSupported();
IsHwpHighestInterruptSupported();
IsHwpIdleOptimizationSupported();
IsHwpNativeInterruptSupported();
IsHwpPackageControlSupported();
IsHwpSupported();
IsMonitorMWaitSupported();
IsNonwrappingACountMCountSupported();
IsPerformanceEnergyBiasSupported();
IsProcSpeedStepCapable();
IsTurboModeSupported();
IsValidAcpiGenericAddress();
IsValidPowerCurve();
LegacyPccInstantaneousFrequency();
LongCapTraceDpc();
LookupNtProcessorNumber();
LpiEnumerateDependencies();
LpiIdleExecute();
LpiTranslateCoordinatedIdleStates();
MWaitIdle();
MWaitIdleCheck();
PccCapWorker();
...
PepDevicePowerControlCallback();
PepDifferentialFrequencyRead();
PepDifferentialPerfRead();
PepGetParkingPageInfo();
PepIdleAvailabilityCheck();
PepIdleCancel();
PepIdleComplete();
PepIdleCompleteV2();
PepIdleExecute();
...
PepIdleVmTest();
PepInitiateWake();
PepInstantaneousFrequencyRead();
PepInstantaneousPerfRead();
PepIsHalted();
PepNotifyCoordinatedLpiStates();
PepNotifyFeedbackRead();
PepNotifyLpiComplete();
PepNotifyLpiPreExecute();
PepNotifyPerfConstraints();
PepNotifyPerfSet();
PepNotifyPerfSetState();
PepNotifyProcessorLpiStates();
PepNotifyQueryCapabilities();
PepNotifyQueryCoordinatedStates();
PepNotifyQueryDiscretePerfStates();
PepNotifyQueryFeedbackCounters();
PepNotifyQueryPerfCapabilities();
PepNotifyQueryProcessorIdleStates();
PepNotifyQueryProcessorIdleStatesV2();
PepNotifyReportCStates();
PepParkMask();
PepParkPreference();
PepPerfCheckComplete();
PepPerfControlHandler();
PepPerfSelectionHandler();
PepPerfStateControlHandler();
PepPerfStateSelectionHandler();
PepPerformanceFromPercentage();
PepPlatformIdleVeto();
PepProcessorIdleVeto();
PepQueryName();
PepQueryPerfDomainInfo();
PepQueryPlatformStateResidency();
PepQueryVetoList();
PepRegisterBootVetoes();
PepRegisterSpmSettings();
PepSetTimeWindow();
PepTranslateCstState();
PepTranslateLimitReason();
PepUpdateCoordinatedStateWorker();
PepUpdateIdleState();
PepUpdateIdleStateWorker();
PepUpdatePerformanceConstraint();
PepUpdatePerformanceConstraintWorker();
PepUpdatePlatformState();
PepUpdatePlatformStateWorker();
PerfCommitLegacyPcc();
PerfControlCpc();
PerfControlCpcSingleRegister();
PerfControlFeedback();
PerfControlHwp();
PerfControlHwpPackage();
PerfControlLegacyPcc();
PerfControlPTStates();
PerfHvReadFeedback();
PerfInitiateLegacyPcc();
PerfReadActualMasterCount();
PerfReadWrappingCounter();
PerfSelectionCpc();
PerfSelectionFeedback();
PerfSelectionHwp();
PerfSelectionLegacyPcc();
PerfSelectionPTStates();
PerfStatesInstantaneousFrequency();
PerformanceFromPercentage();
PopulateEnergyEstimationModel();
ProbeFixedFunctionCounters();
ProbeMsr();
ProcLibCapChange();
ProcLibDeviceCreate();
ProcLibDeviceStart();
ProcLibDriverCleanup();
ProcLibGetProcessorNumber();
ProcLibGlobalInit();
ProcLibThermalNotification();
ProcLibTraceBiosCStatesRundown();
ProcLibTraceBiosPStatesRundown();
ProcLibTraceBiosTStatesRundown();
ProcLibTraceCStateDomainRundown();
ProcLibTraceCap();
ProcLibTraceControlCallback();
ProcLibTraceCoordinatedIdleStates();
ProcLibTraceCoordinatedLpiRundown();
ProcLibTraceEnergyCounterUpdate();
ProcLibTraceGetPlatformIdleStates();
ProcLibTraceGetProcessorIdleStates();
ProcLibTraceGetProcessorIdleStatesV2();
ProcLibTraceIdleStatesErrata();
ProcLibTraceInvalidPowerCurve();
ProcLibTraceNoPayloadEvent();
ProcLibTracePStateDomainRundown();
ProcLibTracePackageEnergyCounterUpdate();
ProcLibTracePccCapChange();
ProcLibTracePccErrata();
ProcLibTracePccSummary();
ProcLibTracePepPerfCapabilities();
ProcLibTracePepPerfDomain();
ProcLibTracePerfConstraintChange();
ProcLibTracePerfStatesErrata();
ProcLibTracePerfStatesRundown();
ProcLibTracePlatformIdleStates();
ProcLibTraceProcessorIds();
ProcLibTraceProcessorLpiRundown();
ProcLibTraceProcessorRundown();
ProcLibTraceProcessorSpecificEvent();
ProcLibTraceQueryCapabilities();
ProcLibTraceSummary();
ProcLibTraceSummary2();
ProcLibTraceThrottleStatesErrata();
ProcLibTraceUnexpectedTurboDisable();
ProcessSystemSleepStateNotify();
QueryPepCapabilites();
QueueCapWork();
QuickCapTraceDpc();
ReadEnergyEquation();
...
ReadIoMemRaw();
ReadPowerCurve();
RegisterGuestIdleStates();
RegisterHvCStates();
RegisterHvCap();
RegisterHvCpc();
RegisterHvCpcCounters();
RegisterHvFeedbackCountersCallback();
RegisterHvIdleStates();
RegisterHvLegacyPcc();
RegisterHvLegacyPccCounters();
RegisterHvPackage();
RegisterHvPepIdleStatesV2();
RegisterHvPerfFeedbackCounters();
RegisterHvPerfStates();
RegisterHvPerfStatesCounters();
RegisterIdleComplete();
RegisterIdleDomain();
RegisterKernelCStates();
RegisterKernelCap();
RegisterKernelCoordinatedLpiStates();
RegisterKernelCoordinatedStates();
RegisterKernelCpc();
RegisterKernelIdleDomains();
RegisterKernelIdleStates();
RegisterKernelLegacyPcc();
RegisterKernelLpiStates();
RegisterKernelPackage();
RegisterKernelPepIdleStates();
RegisterKernelPepIdleStatesV2();
RegisterKernelPepPerf();
RegisterKernelPerfFeedback();
RegisterKernelPerfStates();
RegisterKernelPerfStatesCallback();
RegisterKernelPlatformStates();
RegisterNoop();
RegisterPepDevice();
RegisterSubspace();
RegisterSubspaceForGenAddr();
RegisterSystemSleepStateNotifyHandler();
RegisterVmIdleStates();
RegisterWmi();
RegisterXsdDomain();
ReleaseAcpiInterfaces();
ResetEnumerationContext();
...
SetFFHThrottleState();
SetGV3PerfState();
SetGV3PerfStateAndTurbo();
SetPerfStateFFH();
SetPerfStateIO();
SetPerformanceEnergyBiasPolicy();
SetTurboDisablePolicy();
SnapEnergyCounters();
SnapEnergyCountersDispatch();
StartPccCommand();
TlgDefineProvider_annotation__TlgProcLibTraceHandleProv();
TlgKeywordOn();
TlgWrite();
TraceLoggingRegisterEx();
UnInitEnergyCounters();
UpdateKernelIdleDomains();
UpdateKernelPlatformStates();
ValidateAcpi2PStates();
ValidateAcpiCPC();
ValidateAcpiCPCRegister();
ValidateAcpiCStates();
ValidateAcpiIdleDomain();
ValidateAcpiThrottleStates();
ValidateAcpi_PSD_TSD();
ValidateCoordinatedDependencyOptions();
ValidateCoordinatedDependencyOptionsPlatform();
ValidateCoordinatedDependencyOptionsProcessor();
ValidateCoordinatedLpiDependenciesProcessor();
ValidateCoordinatedLpiStates();
ValidateCoordinatedState();
ValidateCpcSymmetry();
ValidateLpiState();
ValidateMsrGenAddr();
ValidateMsr_PCT();
...
ValidatePccEntry();
ValidatePccHeader();
ValidatePctPtcSymmetry();
ValidatePepPerformanceSymmetry();
ValidatePerfDomainSymmetry();
ValidatePlatformIdleState();
ValidateProcessorLpiStates();
ValidatePssCore();
ValidatePssSymmetry();
ValidateRegisterSymmetry();
ValidateTssSymmetry();
ValidateXPssPStates();
Validate_PCT_PTC();
WPP_RECORDER_SF_();
...
WPP_RECORDER_SF_dds();
WPP_RECORDER_SF_ddsdd();
WPP_RECORDER_SF_ddsddd();
WPP_RECORDER_SF_i();
WPP_RECORDER_SF_ii();
WPP_RECORDER_SF_iii();
WPP_RECORDER_SF_q();
