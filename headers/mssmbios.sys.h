...
typedef struct _SMBIOS_DATA_OBJECT {
    ULONG Tag;
    ULONG Flags;
    struct _UNICODE_STRING Name;
    struct _GUID Guid;
...
SMBiosAmdCPUID;
SMBiosBugCheckCallbackRecordACPI;
SMBiosBugCheckCallbackRecordRegisters;
SMBiosBugCheckCallbackRecordRegistry;
SMBiosBugCheckCallbackRecordSMBios;
SMBiosComputerHardwareIdValue;
SMBiosComputerHardwareIdsValue;
SMBiosComputerId;
SMBiosDriverAcpiObject;
SMBiosDriverRegistersObject;
SMBiosDriverRegistryObject;
SMBiosDriverSMBiosLightObject;
SMBiosDriverSMBiosObject;
SMBiosEnableTargetedContentDistribution;
SMBiosGuidAcpi;
SMBiosGuidBios;
SMBiosGuidList;
SMBiosGuidRegisters;
SMBiosGuidSMBios;
SMBiosGuidSMBiosLight;
SMBiosHardwareIdNameSpace;
SMBiosHardwareIds;
SMBiosIntegerTableNames;
SMBiosIntelCPUID;
SMBiosLibInfo;
SMBiosRegistryPath;
SMBiosStringLock;
SMBiosStrings;
SMBiosSystemBiosMajorRelease;
SMBiosSystemBiosMinorRelease;
SMBiosSystemChassisType;
SMBiosSystemECFirmwareMajorRelease;
SMBiosSystemECFirmwareMinorRelease;
SMBiosTransmetaCPUID1;
SMBiosTransmetaCPUID2;
_IMPORT_DESCRIPTOR_WMILIB;
_IMPORT_DESCRIPTOR_ksecdd;
...
rgzCPUIdentifier;
rgzGlobalIdentifier;
rgzSMBiosProcessorIdentifiers;
WMILIB_NULL_THUNK_DATA;
ksecdd_NULL_THUNK_DATA;
ntoskrnl_NULL_THUNK_DATA;

DriverEntry();
GsDriverEntry();
RtlStringCchPrintfW();
SMBiosACPIProcessACPIData();
SMBiosBigEndian();
SMBiosBugCheckCallbackRoutineACPI();
SMBiosBugCheckCallbackRoutineRegisters();
SMBiosBugCheckCallbackRoutineRegistry();
SMBiosBugCheckCallbackRoutineSMBios();
SMBiosBugCheckRegisterCallbacks();
SMBiosCPUCaptureRegistersForDump();
SMBiosCPUCaptureRegistersForDumpArch();
SMBiosCPUGatherAmdMSRs();
SMBiosCPUGatherCPUID();
SMBiosCPUGatherData();
SMBiosCPUGatherDataQueryRoutine();
SMBiosCPUGatherIntelMSRs();
SMBiosCPUGatherRegisters();
SMBiosCPUID();
SMBiosCPUIDIsPresent();
SMBiosCPUProbeRegisterForDump();
SMBiosCalculateComputerHardwareId();
SMBiosClass5GuidFromBlob();
SMBiosComputeHardwareIds();
SMBiosDataAddObject();
SMBiosDataAddPageableObject();
SMBiosDataDeleteObject();
SMBiosDataInitializeObject();
SMBiosDataResetObject();
SMBiosDataResetObjects();
SMBiosDataSaveObject();
SMBiosDataSaveObjects();
SMBiosDriverAddDevice();
SMBiosDriverPnp();
SMBiosDriverPnpComplete();
SMBiosDriverPower();
SMBiosDriverStartDeviceWorker();
SMBiosDriverUnload();
SMBiosDriverWmi();
SMBiosHardwareIdsSaveToRegistry();
SMBiosHostToNetworkLong();
SMBiosHostToNetworkShort();
SMBiosNetworkToHostLong();
SMBiosNetworkToHostShort();
SMBiosRegistryCreateHandleW();
SMBiosRegistryOpenHandleW();
SMBiosRegistrySaveData();
SMBiosRegistryWriteIntegerW();
SMBiosRegistryWriteMultiStringW();
SMBiosRegistryWriteStringW();
SMBiosRegistryWriteValueW();
SMBiosSMBiosFindStringAndZero();
SMBiosSMBiosFindStructure();
SMBiosSMBiosProcessTable();
SMBiosSMBiosSaveBiosString();
SMBiosSMBiosValidateBios();
SMBiosSMbiosProcessSMBiosData();
SMBiosStringsCopy();
SMBiosStringsDeleteFromRegistry();
SMBiosStringsInitialize();
SMBiosStringsResetStrings();
SMBiosStringsSaveToRegistry();
SMBiosWmiQueryDataBlock();
SMBiosWmiQueryRegInfo();
SMBiosWriteSystemInformationRegistry();
_C_specific_handler();
_GSHandlerCheck();
