...
union _PORTSC;
union _POWER_STATE;
union _QH_LINK_POINTER;
union _SLIST_HEADER;
union _SOFMOD;
union _TD_LINK_POINTER;
union _TRANSFER_BUFFER;
...
typedef struct _DEVICE_DATA {
    ULONG Sig;
    ULONG Flags;
    struct _HC_REGISTER *Registers;
    ULONG HCErrorCount;
    ULONG HCHostSystemErrorCount;
    ULONG HCHostControllerProcessErrorCount;
    union _USBCMD SuspendCommandReg;
    union _FRNUM SuspendFrameNumber;
    union _FRBASEADD SuspendFrameListBasePhys;
    union _USBINTR SuspendInterruptEnable;
    ULONG SuspendPortStatus[2];
    ULONG ResumePortStatus[2];
    ...
    PULONG FrameListVA;
    ULONG FrameListPA;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *ControlQueueHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *BulkQueueHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *LastBulkQueueHead;
    struct _HCD_QUEUEHEAD_DESCRIPTOR *InterruptQueueHeads[63];
    struct _HCD_TRANSFER_DESCRIPTOR *RollOverTd;
    UCHAR SavedSOFModify;
    struct _HCD_TD_LIST *SofTdList;
    struct _HCD_TRANSFER_DESCRIPTOR *ResumeTd;
...
typedef struct _DOUBLE_BUFFER_LIST {
    struct _ASYNC_TRANSFER_BUFFER Async[1];
    struct _ISOCH_TRANSFER_BUFFER Isoch[1];
};
...
typedef struct _ENDPOINT_DATA {
    ...
    struct _HCD_TRANSFER_DESCRIPTOR *TailTd;
    struct _HCD_TRANSFER_DESCRIPTOR *HeadTd;
    struct _HCD_TD_LIST *TdList;
    ULONG TdCount;
    ULONG TdLastAllocced;
    ULONG TdsUsed;
    struct _DOUBLE_BUFFER_LIST *DbList;
    ULONG DbCount;
    ...
    enum _MP_ENDPOINT_STATE CurrentEpState;
    struct _LIST_ENTRY AbortTxCompleteList;
};
...
typedef struct _HCD_TRANSFER_DESCRIPTOR {
    ...
    ULONG RequestFrame;
    struct _MINIPORT_ISO_PACKET *IsoPacket;
    ULONG Flags;
    struct _HCD_TRANSFER_DESCRIPTOR *NextTd;
    union _TRANSFER_BUFFER *DoubleBuffer;
...
typedef struct _HC_REGISTER {
    ...
    union _FRNUM FrameNumber;
    union _FRBASEADD FrameListBasePhys;
    union _SOFMOD StartOfFrameModify;
    UCHAR Reserved[3];
    union _PORTSC PortRegister[2];
};

typedef struct _HW_QUEUE_ELEMENT_TD {
    union _TD_LINK_POINTER LinkPointer;
    union _HC_QTD_CONTROL Control;
    union _HC_QTD_TOKEN Token;
    ULONG Buffer;
};

typedef struct _HW_QUEUE_HEAD {
    union _QH_LINK_POINTER HLink;
    union _TD_LINK_POINTER VLink;
};
...
typedef struct _TRANSFER_CONTEXT {
    ...
    struct _LIST_ENTRY AbortTxCompleteListEntry;
};
...
typedef union _FRNUM {
    USHORT us;
    USHORT FrameListCurrentIndex : 11;
    USHORT Reserved : 5;
};
...
typedef union _PORTSC {
    USHORT us;
    USHORT PortConnect : 1;
    USHORT PortConnectChange : 1;
    USHORT PortEnable : 1;
    USHORT PortEnableChange : 1;
    USHORT LineStatus : 2;
...
typedef union _TD_LINK_POINTER {
    ...
    ULONG Terminate : 1;
    ULONG QHTDSelect : 1;
    ULONG DepthBreadthSelect : 1;
    ULONG Reserved : 1;
    ULONG LinkPointer : 28;
};

typedef union _TRANSFER_BUFFER {
    struct _ISOCH_TRANSFER_BUFFER Isoch;
    struct _ASYNC_TRANSFER_BUFFER Async;
};
...
typedef union _USBCMD {
    USHORT us;
    USHORT RunStop : 1;
    USHORT HostControllerReset : 1;
    USHORT GlobalReset : 1;
    USHORT EnterGlobalSuspendMode : 1;
    USHORT ForceGlobalResume : 1;
    USHORT SoftwareDebug : 1;
    USHORT ConfigureFlag : 1;
    USHORT MaxPacket : 1;
    USHORT Reserved : 8;
};
...
typedef union _USBSTS {
    USHORT us;
    USHORT UsbInterrupt : 1;
    USHORT UsbError : 1;
    USHORT ResumeDetect : 1;
    USHORT HostSystemError : 1;
    USHORT HostControllerProcessError : 1;
    USHORT HCHalted : 1;
    USHORT Reserved : 10;
};
...
GUID_IDLE_STATUS;
RegistrationPacket;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE_ERROR_1;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE_ERROR_2;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE_ERROR_3;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE_ERROR_4;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_COMPLETE_ERROR_5;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_RESUME_DISPATCH;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_START_COMPLETE;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_START_COMPLETE_ERROR_1;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_START_COMPLETE_ERROR_4;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_START_DISPATCH;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_STOP_COMPLETE;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_STOP_DISPATCH;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_SUSPEND_COMPLETE;
USBPORT_ETW_EVENT_HC_UHCI_MINIPORT_SUSPEND_DISPATCH;
