...
GUID_DEVICEINTERFACE_VID;
GUID_DEVICE_INTERFACE_ARRIVAL;
GUID_DEVINTERFACE_FLEXIBLE_IOV_MEMORY_ACCESS_DEVICE;
GUID_DEVINTERFACE_VIRTUALIZABLE_DEVICE;
GUID_DEVINTERFACE_VPCI_VSP;
GUID_EM_PCI_DEVICE_DMA_REMAPPING_ERROR_HANDLING_RULE;
GUID_EM_PCI_DEVICE_INTERRUPT_REMAPPING_NOT_ALL_REMAPPED_RULE;
GUID_EM_PCI_QUERY_IOV_BLACKLIST_RULE;
GUID_FLEXIBLE_IOV_INTERFACE;
GUID_MITIGABLE_DEVICE_INTERFACE;
GUID_SRIOV_DEVICE_INTERFACE_STANDARD;
GUID_VID_VSMM_INTERFACE;
GUID_VPCI_BUS_SAVE_TYPE_ID;
GUID_VPCI_DEVICE_SAVE_TYPE_ID;
GUID_VPCI_VSP_CHANNEL_TYPE;
HalDispatchTable;
PnpIdFromConfig;
PowerStateTable;
RootPortAlternateErrorDelivery_GUID;
StateTable;
VpciPhuCallbackObj;
VpciPhuCallbackRegistered;
VpciPhuCallbackRegistrationHandle;
VpciPhuOperationLock;
WDF_MUX_IOTARGET_CONTEXT_TYPE_INFO;
WDF_VPCI_VSP_DEVICE_CONTEXT_TYPE_INFO;
WDF_VSP_FILE_CONTEXT_TYPE_INFO;
WDF_VSP_IOCTL_VPCI_CREATE_BUS_CONTEXT_TYPE_INFO;
WPPTraceSuite;
WPP_4afc3eb943c03c6123fbcdd370195f08_Traceguids;
WPP_GLOBAL_Control;
WPP_MAIN_CB;
WPP_ThisDir_CTLGUID_VpciDriverTraceGuid;
WPP_b380508092803c865f77f8d4136521b3_Traceguids;
WPP_bb920beb9b283d4c9ba8214c749efc1a_Traceguids;
WPP_d0133f72c2433e6d322ab2c432dc3b43_Traceguids;
WPP_f5efb78480ea3d8fb675b8d390229330_Traceguids;
WPP_fbe061a860a43ab817e6d231f2a6cbbd_Traceguids;
WdfBindInfo;
WdfDriverGlobals;
WdfFunctions_01015;
...
_imp_VmbChannelAllocate;
_imp_VmbChannelCleanup;
_imp_VmbChannelDisable;
_imp_VmbChannelEnable;
_imp_VmbChannelGetInterfaceInstance;
_imp_VmbChannelGetPointer;
_imp_VmbChannelInitSetMaximumPacketSize;
_imp_VmbChannelInitSetProcessPacketCallbacks;
_imp_VmbChannelInitSetStateChangeCallbacks;
_imp_VmbChannelLockChildPages;
...
_imp_VmbChannelUnlockChildPages;
_imp_VmbConvertVmbusHandleToKernelHandle;
_imp_VmbPacketAllocate;
_imp_VmbPacketFree;
...
_imp_WinHvAssertDeviceInterrupt;
_imp_WinHvAttachDevice;
_imp_WinHvDetachDevice;
_imp_WinHvMapDeviceInterruptEx;
_imp_WinHvQueryDeviceInterruptTarget;
_imp_WinHvUnmapDeviceInterrupt;
...
DisableErrorDeliveryWmi();
DriverEntry();
EnableErrorDeliveryWmi();
FlexIovGuestMemoryAccess_DereferenceInterface();
FlexIovGuestMemoryAccess_LockChildRange();
FlexIovGuestMemoryAccess_ReferenceInterface();
FlexIovGuestMemoryAccess_UnlockChildRange();
FxDriverEntry();
FxDriverEntryWorker();
FxStubBindClasses();
FxStubDriverUnload();
...
MuxAttach();
MuxAttachToRootForSharedDevice();
MuxCancelWaitForNotification();
MuxCleanup();
MuxDetach();
MuxEvtIoTargetQueryRemove();
MuxEvtIoTargetRemoveCanceled();
MuxEvtIoTargetRemoveComplete();
MuxFreeFlexIovDevice();
MuxGetDeviceLocations();
MuxGetMmioMappedPageList();
MuxGetSriovVersion();
MuxHasFullFlexIoHardware();
MuxInitialize();
MuxQueryProbedBars();
MuxReadVfConfig();
MuxResetAnyVf();
...
MuxpAttachExisting();
MuxpAttachNewTarget();
MuxpDereferenceProxy();
MuxpDeviceArrivalCallback();
MuxpDeviceInterfaceCallback();
MuxpDeviceRemovalCallback();
MuxpDropProxy();
MuxpEventComplete();
MuxpFiovMmioUpdateWorkItem();
MuxpGetHwVirtLevelInternal();
MuxpHasFullFlexIoHardware();
MuxpHasPartialFlexIoHardware();
MuxpInvalidateBlockCompletion();
MuxpInvalidationWorkItem();
MuxpMitigationUpdateCompletion();
MuxpMitigationUpdateWorkItem();
MuxpNotificationCompletion();
MuxpNotificationWorkItem();
MuxpReferenceProxy();
MuxpSendAttachDetach();
MuxpSendBlockInvalidateRequest();
MuxpSendEventToClients();
MuxpSendMitigationUpdate();
MuxpSendNotificationRequest();
MuxpSharedProxyDestroy();
MuxpWaitForAttach();
ParsePciLocationString();
PciGetLengthFromBar();
PickupVidInterfaces();
QueryIovBlackListDevices();
QueryRootPortErrorHandler();
ReenableErrorDeliveryWmi();
RootPortAttach();
RootPortDetach();
VirtualBusChannelClosed();
VirtualBusChannelOpened();
VirtualBusChannelProcessPacket();
VirtualBusChannelStarted();
VirtualBusChannelSuspend();
VirtualBusCheckDStateChanges();
VirtualBusConvertToResourceFormat2();
VirtualBusCreate();
VirtualBusDelete();
VirtualBusDereference();
VirtualBusEndPersistedPhu();
VirtualBusFdoDxChange();
VirtualBusFindMitigatedRegister();
VirtualBusFinishAddingNewDeviceAndReleaseLock();
VirtualBusFreeAllPersistedPhu();
VirtualBusGetDevicePnpIds();
VirtualBusGetHypervisorDeviceIds();
VirtualBusInsertDevice();
VirtualBusInvalidationPacketDestroy();
VirtualBusLookupDevice();
VirtualBusOfferVirtualDevice();
VirtualBusPacketComplete();
VirtualBusPauseOrResumeVpsAndWait();
VirtualBusPhuRestoreDevice();
VirtualBusProcessProtocol();
VirtualBusReadConfig();
VirtualBusRelationsPacketCreate();
VirtualBusRelationsPacketDestroy();
VirtualBusRevokeDevice();
VirtualBusScanDeviceCapabilities();
VirtualBusSendBusRelationsCompletion();
VirtualBusSendBusRelationsPacket();
VirtualBusSendEject();
VirtualBusSendQueryStop();
VirtualBusSendReenable();
VirtualBusValidateGuestMmioRange();
VirtualBusValidateNewDevice();
VirtualBusWriteConfig();
VirtualDeviceAddHardware();
VirtualDeviceAssignResourcesMessage();
VirtualDeviceAssignResourcesMessage2();
VirtualDeviceAttachHv();
VirtualDeviceBeginSave();
VirtualDeviceBuildMapping();
VirtualDeviceCollectHostResources();
VirtualDeviceCollectMmioMappings();
VirtualDeviceCollectResourceRequirements();
VirtualDeviceCompleteSave();
VirtualDeviceContinueSave();
VirtualDeviceCreate();
VirtualDeviceCreateSingleInterrupt();
VirtualDeviceD0Message();
VirtualDeviceDeleteSingleInterrupt();
VirtualDeviceDereference();
VirtualDeviceDestroy();
VirtualDeviceDetachHv();
VirtualDeviceDropProxy();
VirtualDeviceDxMessage();
VirtualDeviceEventComplete();
VirtualDeviceFreeAllPersistedPhu();
VirtualDeviceFullyMapVirtualBar();
VirtualDeviceGetSetMappingContexts();
VirtualDeviceGetVspEventFromMuxPfEvent();
VirtualDeviceInvalidateBlock();
VirtualDeviceInvalidateBlockCompletion();
VirtualDeviceLockState();
VirtualDeviceMapBARs();
VirtualDeviceMapIDT();
VirtualDeviceMapInterrupts();
VirtualDeviceMapMdlMmioSpace();
VirtualDeviceMapMmioSpace();
VirtualDeviceMinimalRemap();
VirtualDeviceNotificationWorkItem();
VirtualDeviceProxyD0();
VirtualDeviceProxyDx();
VirtualDeviceReadBlock();
VirtualDeviceReference();
VirtualDeviceRemapHardware();
VirtualDeviceRemoveHardware();
VirtualDeviceResetFunction();
VirtualDeviceRestore();
VirtualDeviceRunPowerStateMachine();
VirtualDeviceRunRestoreStateMachine();
VirtualDeviceRunStateMachine();
VirtualDeviceRunStateMachineOnce();
VirtualDeviceSendNotificationRequest();
VirtualDeviceSendResourcesTranslated();
VirtualDeviceSetBusMasterEnable();
VirtualDeviceSwitchGuestVirtualPhysicalBegin();
VirtualDeviceSwitchGuestVirtualPhysicalEnd();
VirtualDeviceTimerDpc();
VirtualDeviceTimerFires();
VirtualDeviceTimerFiresWdm();
VirtualDeviceUnLockState();
VirtualDeviceUnmapBARs();
VirtualDeviceUnmapIDT();
VirtualDeviceUnmapInterrupts();
VirtualDeviceUpdateInterruptRequests();
VirtualDeviceUpdateMitigatedPages();
VirtualDeviceWaitForRevoke();
VirtualDeviceWriteBlock();
VpciCancelWaitForDState();
VpciCancelWaitForVpPause();
VpciGetBusChannelFromRequest();
VpciIoctlAddHardware();
VpciIoctlAssignDevice();
VpciIoctlCancelWaitForMitigations();
VpciIoctlCompleteDState();
VpciIoctlCompleteMitigations();
VpciIoctlCreateBus();
VpciIoctlDeliverInterrupt();
VpciIoctlFastSaveBus();
VpciIoctlFastSaveDevice();
VpciIoctlFlexIovAllocate();
VpciIoctlFlexIovFree();
VpciIoctlOfferVirtualDevice();
VpciIoctlQueryErrataInfo();
VpciIoctlQueryMitigations();
VpciIoctlReadRegister();
VpciIoctlReadWriteConfig();
VpciIoctlRemoveHardware();
VpciIoctlRestoreState();
VpciIoctlSaveStateBegin();
VpciIoctlSaveStateContinue();
VpciIoctlUnplugDevice();
VpciIoctlWaitForDState();
VpciIoctlWaitForMitigations();
VpciIoctlWaitForVpPause();
VpciIoctlWriteRegister();
VpciPhuCallbackRegister();
VpciPhuCallbackTeardown();
VpciPhupCallback();
VspDriverUnload();
VspEvtDeviceAdd();
VspEvtDeviceCleanup();
...
VspEvtIoInCallerContext();
VspEvtIoStop();
VspEvtPreProcessPower();
VspExposeInterfaces();
VspFileExitSerializedIoctl();
VspFileIsSerializedIoctl();
VspFileObjectDestroy();
VspFilePerformStateTransition();
VspFileTryEnterSerializedIoctl();
VspFindDeviceFromVfLuid();
WPP_RECORDER_SF_();
WPP_RECORDER_SF_D();
WPP_RECORDER_SF_Dd();
WPP_RECORDER_SF_Dq();
WPP_RECORDER_SF_Id();
WPP_RECORDER_SF_Z();
WPP_RECORDER_SF_ZDDDD();
WPP_RECORDER_SF_ZDDd();
WPP_RECORDER_SF_Zd();
WPP_RECORDER_SF_d();
WPP_RECORDER_SF_dD();
WPP_RECORDER_SF_dIii();
WPP_RECORDER_SF_dIqq();
WPP_RECORDER_SF_dd();
WPP_RECORDER_SF_q();
WPP_RECORDER_SF_qD();
WPP_RECORDER_SF_qDD();
...
WPP_RECORDER_SF_q_guid__guid_q();
WPP_RECORDER_SF_q_guid_q();
WPP_RECORDER_SF_qd();
WPP_RECORDER_SF_qdD();
...
WPP_RECORDER_SF_qdiD();
WPP_RECORDER_SF_qdiiD();
WPP_RECORDER_SF_qdq();
WPP_RECORDER_SF_qi();
WPP_RECORDER_SF_qiD();
WPP_RECORDER_SF_qq();
WPP_RECORDER_SF_qqDDDDd();
WPP_RECORDER_SF_qqL();
WPP_RECORDER_SF_qqc();
WPP_RECORDER_SF_qqd();
